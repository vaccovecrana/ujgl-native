...
public class VkPhysicalDeviceVulkan13Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("robustImageAccess"),
        rgfw_h.C_INT.withName("inlineUniformBlock"),
        rgfw_h.C_INT.withName("descriptorBindingInlineUniformBlockUpdateAfterBind"),
        rgfw_h.C_INT.withName("pipelineCreationCacheControl"),
        rgfw_h.C_INT.withName("privateData"),
        rgfw_h.C_INT.withName("shaderDemoteToHelperInvocation"),
        rgfw_h.C_INT.withName("shaderTerminateInvocation"),
        rgfw_h.C_INT.withName("subgroupSizeControl"),
        rgfw_h.C_INT.withName("computeFullSubgroups"),
        rgfw_h.C_INT.withName("synchronization2"),
        rgfw_h.C_INT.withName("textureCompressionASTC_HDR"),
        rgfw_h.C_INT.withName("shaderZeroInitializeWorkgroupMemory"),
        rgfw_h.C_INT.withName("dynamicRendering"),
        rgfw_h.C_INT.withName("shaderIntegerDotProduct"),
        rgfw_h.C_INT.withName("maintenance4"),
        MemoryLayout.paddingLayout(4)
