...
public class VkPhysicalDeviceExtendedDynamicState3FeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("extendedDynamicState3TessellationDomainOrigin"),
        rgfw_h.C_INT.withName("extendedDynamicState3DepthClampEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3PolygonMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3RasterizationSamples"),
        rgfw_h.C_INT.withName("extendedDynamicState3SampleMask"),
        rgfw_h.C_INT.withName("extendedDynamicState3AlphaToCoverageEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3AlphaToOneEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3LogicOpEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3ColorBlendEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3ColorBlendEquation"),
        rgfw_h.C_INT.withName("extendedDynamicState3ColorWriteMask"),
        rgfw_h.C_INT.withName("extendedDynamicState3RasterizationStream"),
        rgfw_h.C_INT.withName("extendedDynamicState3ConservativeRasterizationMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3ExtraPrimitiveOverestimationSize"),
        rgfw_h.C_INT.withName("extendedDynamicState3DepthClipEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3SampleLocationsEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3ColorBlendAdvanced"),
        rgfw_h.C_INT.withName("extendedDynamicState3ProvokingVertexMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3LineRasterizationMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3LineStippleEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3DepthClipNegativeOneToOne"),
        rgfw_h.C_INT.withName("extendedDynamicState3ViewportWScalingEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3ViewportSwizzle"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageToColorEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageToColorLocation"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageModulationMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageModulationTableEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageModulationTable"),
        rgfw_h.C_INT.withName("extendedDynamicState3CoverageReductionMode"),
        rgfw_h.C_INT.withName("extendedDynamicState3RepresentativeFragmentTestEnable"),
        rgfw_h.C_INT.withName("extendedDynamicState3ShadingRateImageEnable"),
        MemoryLayout.paddingLayout(4)
