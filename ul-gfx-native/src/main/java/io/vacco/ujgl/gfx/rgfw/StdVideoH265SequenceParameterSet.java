...
public class StdVideoH265SequenceParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("chroma_format_idc"),
        rgfw_h.C_INT.withName("pic_width_in_luma_samples"),
        rgfw_h.C_INT.withName("pic_height_in_luma_samples"),
        rgfw_h.C_CHAR.withName("sps_video_parameter_set_id"),
        rgfw_h.C_CHAR.withName("sps_max_sub_layers_minus1"),
        rgfw_h.C_CHAR.withName("sps_seq_parameter_set_id"),
        rgfw_h.C_CHAR.withName("bit_depth_luma_minus8"),
        rgfw_h.C_CHAR.withName("bit_depth_chroma_minus8"),
        rgfw_h.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
        rgfw_h.C_CHAR.withName("log2_min_luma_coding_block_size_minus3"),
        rgfw_h.C_CHAR.withName("log2_diff_max_min_luma_coding_block_size"),
        rgfw_h.C_CHAR.withName("log2_min_luma_transform_block_size_minus2"),
        rgfw_h.C_CHAR.withName("log2_diff_max_min_luma_transform_block_size"),
        rgfw_h.C_CHAR.withName("max_transform_hierarchy_depth_inter"),
        rgfw_h.C_CHAR.withName("max_transform_hierarchy_depth_intra"),
        rgfw_h.C_CHAR.withName("num_short_term_ref_pic_sets"),
        rgfw_h.C_CHAR.withName("num_long_term_ref_pics_sps"),
        rgfw_h.C_CHAR.withName("pcm_sample_bit_depth_luma_minus1"),
        rgfw_h.C_CHAR.withName("pcm_sample_bit_depth_chroma_minus1"),
        rgfw_h.C_CHAR.withName("log2_min_pcm_luma_coding_block_size_minus3"),
        rgfw_h.C_CHAR.withName("log2_diff_max_min_pcm_luma_coding_block_size"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_CHAR.withName("reserved2"),
        rgfw_h.C_CHAR.withName("palette_max_size"),
        rgfw_h.C_CHAR.withName("delta_palette_max_predictor_size"),
        rgfw_h.C_CHAR.withName("motion_vector_resolution_control_idc"),
        rgfw_h.C_CHAR.withName("sps_num_palette_predictor_initializers_minus1"),
        rgfw_h.C_INT.withName("conf_win_left_offset"),
        rgfw_h.C_INT.withName("conf_win_right_offset"),
        rgfw_h.C_INT.withName("conf_win_top_offset"),
        rgfw_h.C_INT.withName("conf_win_bottom_offset"),
        rgfw_h.C_POINTER.withName("pProfileTierLevel"),
        rgfw_h.C_POINTER.withName("pDecPicBufMgr"),
        rgfw_h.C_POINTER.withName("pScalingLists"),
        rgfw_h.C_POINTER.withName("pShortTermRefPicSet"),
        rgfw_h.C_POINTER.withName("pLongTermRefPicsSps"),
        rgfw_h.C_POINTER.withName("pSequenceParameterSetVui"),
        rgfw_h.C_POINTER.withName("pPredictorPaletteEntries")
