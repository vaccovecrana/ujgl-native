...
public class VkIndirectCommandsLayoutTokenNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("stream"),
        glfw3_h.C_INT.withName("offset"),
        glfw3_h.C_INT.withName("vertexBindingUnit"),
        glfw3_h.C_INT.withName("vertexDynamicStride"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pushconstantPipelineLayout"),
        glfw3_h.C_INT.withName("pushconstantShaderStageFlags"),
        glfw3_h.C_INT.withName("pushconstantOffset"),
        glfw3_h.C_INT.withName("pushconstantSize"),
        glfw3_h.C_INT.withName("indirectStateFlags"),
        glfw3_h.C_INT.withName("indexTypeCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pIndexTypes"),
        glfw3_h.C_POINTER.withName("pIndexTypeValues")
