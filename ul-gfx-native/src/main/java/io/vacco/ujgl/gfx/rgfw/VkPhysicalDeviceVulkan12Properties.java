...
public class VkPhysicalDeviceVulkan12Properties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("driverID"),
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("driverName"),
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("driverInfo"),
        VkConformanceVersion.layout().withName("conformanceVersion"),
        rgfw_h.C_INT.withName("denormBehaviorIndependence"),
        rgfw_h.C_INT.withName("roundingModeIndependence"),
        rgfw_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat16"),
        rgfw_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat32"),
        rgfw_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat64"),
        rgfw_h.C_INT.withName("shaderDenormPreserveFloat16"),
        rgfw_h.C_INT.withName("shaderDenormPreserveFloat32"),
        rgfw_h.C_INT.withName("shaderDenormPreserveFloat64"),
        rgfw_h.C_INT.withName("shaderDenormFlushToZeroFloat16"),
        rgfw_h.C_INT.withName("shaderDenormFlushToZeroFloat32"),
        rgfw_h.C_INT.withName("shaderDenormFlushToZeroFloat64"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTEFloat16"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTEFloat32"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTEFloat64"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTZFloat16"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTZFloat32"),
        rgfw_h.C_INT.withName("shaderRoundingModeRTZFloat64"),
        rgfw_h.C_INT.withName("maxUpdateAfterBindDescriptorsInAllPools"),
        rgfw_h.C_INT.withName("shaderUniformBufferArrayNonUniformIndexingNative"),
        rgfw_h.C_INT.withName("shaderSampledImageArrayNonUniformIndexingNative"),
        rgfw_h.C_INT.withName("shaderStorageBufferArrayNonUniformIndexingNative"),
        rgfw_h.C_INT.withName("shaderStorageImageArrayNonUniformIndexingNative"),
        rgfw_h.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexingNative"),
        rgfw_h.C_INT.withName("robustBufferAccessUpdateAfterBind"),
        rgfw_h.C_INT.withName("quadDivergentImplicitLod"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSamplers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindUniformBuffers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageBuffers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSampledImages"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageImages"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindInputAttachments"),
        rgfw_h.C_INT.withName("maxPerStageUpdateAfterBindResources"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindSamplers"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffers"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffersDynamic"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffers"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffersDynamic"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindSampledImages"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageImages"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindInputAttachments"),
        rgfw_h.C_INT.withName("supportedDepthResolveModes"),
        rgfw_h.C_INT.withName("supportedStencilResolveModes"),
        rgfw_h.C_INT.withName("independentResolveNone"),
        rgfw_h.C_INT.withName("independentResolve"),
        rgfw_h.C_INT.withName("filterMinmaxSingleComponentFormats"),
        rgfw_h.C_INT.withName("filterMinmaxImageComponentMapping"),
        rgfw_h.C_LONG.withName("maxTimelineSemaphoreValueDifference"),
        rgfw_h.C_INT.withName("framebufferIntegerColorSampleCounts"),
        MemoryLayout.paddingLayout(4)
