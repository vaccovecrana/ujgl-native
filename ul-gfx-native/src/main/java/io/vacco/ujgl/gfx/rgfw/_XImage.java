...
public class _XImage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("xoffset"),
        rgfw_h.C_INT.withName("format"),
        rgfw_h.C_POINTER.withName("data"),
        ...
        rgfw_h.C_INT.withName("bytes_per_line"),
        rgfw_h.C_INT.withName("bits_per_pixel"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("red_mask"),
        rgfw_h.C_LONG.withName("green_mask"),
        rgfw_h.C_LONG.withName("blue_mask"),
        rgfw_h.C_POINTER.withName("obdata"),
    ...
    private static final long xoffset$OFFSET = $LAYOUT.byteOffset(groupElement("xoffset"));
    ...
    private static final long bytes_per_line$OFFSET = $LAYOUT.byteOffset(groupElement("bytes_per_line"));
    ...
    private static final long red_mask$OFFSET = $LAYOUT.byteOffset(groupElement("red_mask"));
    ...
    private static final long green_mask$OFFSET = $LAYOUT.byteOffset(groupElement("green_mask"));
    ...
    private static final long blue_mask$OFFSET = $LAYOUT.byteOffset(groupElement("blue_mask"));
    ...
    private static final long obdata$OFFSET = $LAYOUT.byteOffset(groupElement("obdata"));
    ...
    public static class funcs {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            rgfw_h.C_POINTER.withName("create_image"),
            rgfw_h.C_POINTER.withName("destroy_image"),
            rgfw_h.C_POINTER.withName("get_pixel"),
            rgfw_h.C_POINTER.withName("put_pixel"),
            rgfw_h.C_POINTER.withName("sub_image"),
            rgfw_h.C_POINTER.withName("add_pixel")
        ).withName("funcs");
         ...
         * }
         */
        public final static class create_image {
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(create_image.Function.class, "apply", $DESC);
        ...
        private static final long create_image$OFFSET = $LAYOUT.byteOffset(groupElement("create_image"));
         ...
         * }
         */
        public final static class destroy_image {

            private destroy_image() {
                // Should not be called directly
            }
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(destroy_image.Function.class, "apply", $DESC);
        ...
        private static final long destroy_image$OFFSET = $LAYOUT.byteOffset(groupElement("destroy_image"));
         ...
         * }
         */
        public final static class get_pixel {
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(get_pixel.Function.class, "apply", $DESC);
        ...
        private static final long get_pixel$OFFSET = $LAYOUT.byteOffset(groupElement("get_pixel"));
         ...
         * }
         */
        public final static class put_pixel {
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(put_pixel.Function.class, "apply", $DESC);
        ...
        private static final long put_pixel$OFFSET = $LAYOUT.byteOffset(groupElement("put_pixel"));
         ...
         * }
         */
        public final static class sub_image {
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(sub_image.Function.class, "apply", $DESC);
        ...
        private static final long sub_image$OFFSET = $LAYOUT.byteOffset(groupElement("sub_image"));
         ...
         * }
         */
        public final static class add_pixel {
            ...
            private static final MethodHandle UP$MH = rgfw_h.upcallHandle(add_pixel.Function.class, "apply", $DESC);
        ...
        private static final long add_pixel$OFFSET = $LAYOUT.byteOffset(groupElement("add_pixel"));
