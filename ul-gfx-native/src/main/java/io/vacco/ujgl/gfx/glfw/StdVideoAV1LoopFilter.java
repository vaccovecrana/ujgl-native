...
public class StdVideoAV1LoopFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, glfw3_h.C_CHAR).withName("loop_filter_level"),
        glfw3_h.C_CHAR.withName("loop_filter_sharpness"),
        glfw3_h.C_CHAR.withName("update_ref_delta"),
        MemoryLayout.sequenceLayout(8, glfw3_h.C_CHAR).withName("loop_filter_ref_deltas"),
        glfw3_h.C_CHAR.withName("update_mode_delta"),
        MemoryLayout.sequenceLayout(2, glfw3_h.C_CHAR).withName("loop_filter_mode_deltas"),
