...
public class XIMCallback {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_POINTER.withName("client_data"),
        rgfw_h.C_POINTER.withName("callback")
    ).withName("$anon$1231:9");
    ...
    private static final long client_data$OFFSET = $LAYOUT.byteOffset(groupElement("client_data"));
