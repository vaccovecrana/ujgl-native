...
public class VkStencilOpState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("failOp"),
        rgfw_h.C_INT.withName("passOp"),
        rgfw_h.C_INT.withName("depthFailOp"),
        rgfw_h.C_INT.withName("compareOp"),
        rgfw_h.C_INT.withName("compareMask"),
        rgfw_h.C_INT.withName("writeMask"),
        rgfw_h.C_INT.withName("reference")
