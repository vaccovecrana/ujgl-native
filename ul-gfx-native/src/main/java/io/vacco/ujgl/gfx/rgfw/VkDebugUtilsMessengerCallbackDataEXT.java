...
public class VkDebugUtilsMessengerCallbackDataEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pMessageIdName"),
        rgfw_h.C_INT.withName("messageIdNumber"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pMessage"),
        rgfw_h.C_INT.withName("queueLabelCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pQueueLabels"),
        rgfw_h.C_INT.withName("cmdBufLabelCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pCmdBufLabels"),
        rgfw_h.C_INT.withName("objectCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pObjects")
