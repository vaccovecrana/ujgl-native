...
public class VkAcquireNextImageInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_POINTER.withName("swapchain"),
        rgfw_h.C_LONG.withName("timeout"),
        rgfw_h.C_POINTER.withName("semaphore"),
        rgfw_h.C_POINTER.withName("fence"),
        rgfw_h.C_INT.withName("deviceMask"),
        MemoryLayout.paddingLayout(4)
