...
public class VkDescriptorUpdateTemplateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("descriptorUpdateEntryCount"),
        rgfw_h.C_POINTER.withName("pDescriptorUpdateEntries"),
        rgfw_h.C_INT.withName("templateType"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("descriptorSetLayout"),
        rgfw_h.C_INT.withName("pipelineBindPoint"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pipelineLayout"),
        rgfw_h.C_INT.withName("set"),
        MemoryLayout.paddingLayout(4)
