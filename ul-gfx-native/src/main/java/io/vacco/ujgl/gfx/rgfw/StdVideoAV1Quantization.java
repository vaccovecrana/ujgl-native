...
public class StdVideoAV1Quantization {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("base_q_idx"),
        rgfw_h.C_CHAR.withName("DeltaQYDc"),
        rgfw_h.C_CHAR.withName("DeltaQUDc"),
        rgfw_h.C_CHAR.withName("DeltaQUAc"),
        rgfw_h.C_CHAR.withName("DeltaQVDc"),
        rgfw_h.C_CHAR.withName("DeltaQVAc"),
        rgfw_h.C_CHAR.withName("qm_y"),
        rgfw_h.C_CHAR.withName("qm_u"),
        rgfw_h.C_CHAR.withName("qm_v"),
