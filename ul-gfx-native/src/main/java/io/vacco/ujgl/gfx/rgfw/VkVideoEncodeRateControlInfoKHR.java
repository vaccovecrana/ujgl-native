...
public class VkVideoEncodeRateControlInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("rateControlMode"),
        rgfw_h.C_INT.withName("layerCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pLayers"),
        rgfw_h.C_INT.withName("virtualBufferSizeInMs"),
        rgfw_h.C_INT.withName("initialVirtualBufferSizeInMs")
