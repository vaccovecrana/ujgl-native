...
public class XMappingEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("request"),
        rgfw_h.C_INT.withName("first_keycode"),
    ...
    private static final long first_keycode$OFFSET = $LAYOUT.byteOffset(groupElement("first_keycode"));
