...
public class StdVideoH265SequenceParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("chroma_format_idc"),
        glfw3_h.C_INT.withName("pic_width_in_luma_samples"),
        glfw3_h.C_INT.withName("pic_height_in_luma_samples"),
        glfw3_h.C_CHAR.withName("sps_video_parameter_set_id"),
        glfw3_h.C_CHAR.withName("sps_max_sub_layers_minus1"),
        glfw3_h.C_CHAR.withName("sps_seq_parameter_set_id"),
        glfw3_h.C_CHAR.withName("bit_depth_luma_minus8"),
        glfw3_h.C_CHAR.withName("bit_depth_chroma_minus8"),
        glfw3_h.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
        glfw3_h.C_CHAR.withName("log2_min_luma_coding_block_size_minus3"),
        glfw3_h.C_CHAR.withName("log2_diff_max_min_luma_coding_block_size"),
        glfw3_h.C_CHAR.withName("log2_min_luma_transform_block_size_minus2"),
        glfw3_h.C_CHAR.withName("log2_diff_max_min_luma_transform_block_size"),
        glfw3_h.C_CHAR.withName("max_transform_hierarchy_depth_inter"),
        glfw3_h.C_CHAR.withName("max_transform_hierarchy_depth_intra"),
        glfw3_h.C_CHAR.withName("num_short_term_ref_pic_sets"),
        glfw3_h.C_CHAR.withName("num_long_term_ref_pics_sps"),
        glfw3_h.C_CHAR.withName("pcm_sample_bit_depth_luma_minus1"),
        glfw3_h.C_CHAR.withName("pcm_sample_bit_depth_chroma_minus1"),
        glfw3_h.C_CHAR.withName("log2_min_pcm_luma_coding_block_size_minus3"),
        glfw3_h.C_CHAR.withName("log2_diff_max_min_pcm_luma_coding_block_size"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_CHAR.withName("reserved2"),
        glfw3_h.C_CHAR.withName("palette_max_size"),
        glfw3_h.C_CHAR.withName("delta_palette_max_predictor_size"),
        glfw3_h.C_CHAR.withName("motion_vector_resolution_control_idc"),
        glfw3_h.C_CHAR.withName("sps_num_palette_predictor_initializers_minus1"),
        glfw3_h.C_INT.withName("conf_win_left_offset"),
        glfw3_h.C_INT.withName("conf_win_right_offset"),
        glfw3_h.C_INT.withName("conf_win_top_offset"),
        glfw3_h.C_INT.withName("conf_win_bottom_offset"),
        glfw3_h.C_POINTER.withName("pProfileTierLevel"),
        glfw3_h.C_POINTER.withName("pDecPicBufMgr"),
        glfw3_h.C_POINTER.withName("pScalingLists"),
        glfw3_h.C_POINTER.withName("pShortTermRefPicSet"),
        glfw3_h.C_POINTER.withName("pLongTermRefPicsSps"),
        glfw3_h.C_POINTER.withName("pSequenceParameterSetVui"),
        glfw3_h.C_POINTER.withName("pPredictorPaletteEntries")
