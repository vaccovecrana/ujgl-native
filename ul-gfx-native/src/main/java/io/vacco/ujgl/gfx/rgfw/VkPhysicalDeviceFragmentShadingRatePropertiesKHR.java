...
public class VkPhysicalDeviceFragmentShadingRatePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("maxFragmentShadingRateAttachmentTexelSizeAspectRatio"),
        rgfw_h.C_INT.withName("primitiveFragmentShadingRateWithMultipleViewports"),
        rgfw_h.C_INT.withName("layeredShadingRateAttachments"),
        rgfw_h.C_INT.withName("fragmentShadingRateNonTrivialCombinerOps"),
        VkExtent2D.layout().withName("maxFragmentSize"),
        rgfw_h.C_INT.withName("maxFragmentSizeAspectRatio"),
        rgfw_h.C_INT.withName("maxFragmentShadingRateCoverageSamples"),
        rgfw_h.C_INT.withName("maxFragmentShadingRateRasterizationSamples"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithShaderDepthStencilWrites"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithSampleMask"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithShaderSampleMask"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithConservativeRasterization"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithFragmentShaderInterlock"),
        rgfw_h.C_INT.withName("fragmentShadingRateWithCustomSampleLocations"),
        rgfw_h.C_INT.withName("fragmentShadingRateStrictMultiplyCombiner")
