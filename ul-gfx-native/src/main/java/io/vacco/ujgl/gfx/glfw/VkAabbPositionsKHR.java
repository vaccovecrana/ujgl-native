...
public class VkAabbPositionsKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_FLOAT.withName("minX"),
        glfw3_h.C_FLOAT.withName("minY"),
        glfw3_h.C_FLOAT.withName("minZ"),
        glfw3_h.C_FLOAT.withName("maxX"),
        glfw3_h.C_FLOAT.withName("maxY"),
        glfw3_h.C_FLOAT.withName("maxZ")
