...
public class XArc {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_SHORT.withName("x"),
        rgfw_h.C_SHORT.withName("y"),
        rgfw_h.C_SHORT.withName("width"),
        rgfw_h.C_SHORT.withName("height"),
        rgfw_h.C_SHORT.withName("angle1"),
        rgfw_h.C_SHORT.withName("angle2")
    ).withName("$anon$431:9");
    ...
    private static final long angle1$OFFSET = $LAYOUT.byteOffset(groupElement("angle1"));
    ...
    private static final long angle2$OFFSET = $LAYOUT.byteOffset(groupElement("angle2"));
