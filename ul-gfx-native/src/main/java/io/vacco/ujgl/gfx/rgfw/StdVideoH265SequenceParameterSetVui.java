...
public class StdVideoH265SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("aspect_ratio_idc"),
        rgfw_h.C_SHORT.withName("sar_width"),
        rgfw_h.C_SHORT.withName("sar_height"),
        rgfw_h.C_CHAR.withName("video_format"),
        rgfw_h.C_CHAR.withName("colour_primaries"),
        rgfw_h.C_CHAR.withName("transfer_characteristics"),
        rgfw_h.C_CHAR.withName("matrix_coeffs"),
        rgfw_h.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        rgfw_h.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_CHAR.withName("reserved2"),
        rgfw_h.C_SHORT.withName("def_disp_win_left_offset"),
        rgfw_h.C_SHORT.withName("def_disp_win_right_offset"),
        rgfw_h.C_SHORT.withName("def_disp_win_top_offset"),
        rgfw_h.C_SHORT.withName("def_disp_win_bottom_offset"),
        rgfw_h.C_INT.withName("vui_num_units_in_tick"),
        rgfw_h.C_INT.withName("vui_time_scale"),
        rgfw_h.C_INT.withName("vui_num_ticks_poc_diff_one_minus1"),
        rgfw_h.C_SHORT.withName("min_spatial_segmentation_idc"),
        rgfw_h.C_SHORT.withName("reserved3"),
        rgfw_h.C_CHAR.withName("max_bytes_per_pic_denom"),
        rgfw_h.C_CHAR.withName("max_bits_per_min_cu_denom"),
        rgfw_h.C_CHAR.withName("log2_max_mv_length_horizontal"),
        rgfw_h.C_CHAR.withName("log2_max_mv_length_vertical"),
        rgfw_h.C_POINTER.withName("pHrdParameters")
