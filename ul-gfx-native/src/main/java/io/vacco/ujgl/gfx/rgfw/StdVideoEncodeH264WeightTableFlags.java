...
public class StdVideoEncodeH264WeightTableFlags {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("luma_weight_l0_flag"),
        rgfw_h.C_INT.withName("chroma_weight_l0_flag"),
        rgfw_h.C_INT.withName("luma_weight_l1_flag"),
        rgfw_h.C_INT.withName("chroma_weight_l1_flag")
