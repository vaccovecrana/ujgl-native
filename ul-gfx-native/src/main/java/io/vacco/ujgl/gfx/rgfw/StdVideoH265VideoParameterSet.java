...
public class StdVideoH265VideoParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("vps_video_parameter_set_id"),
        rgfw_h.C_CHAR.withName("vps_max_sub_layers_minus1"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_CHAR.withName("reserved2"),
        rgfw_h.C_INT.withName("vps_num_units_in_tick"),
        rgfw_h.C_INT.withName("vps_time_scale"),
        rgfw_h.C_INT.withName("vps_num_ticks_poc_diff_one_minus1"),
