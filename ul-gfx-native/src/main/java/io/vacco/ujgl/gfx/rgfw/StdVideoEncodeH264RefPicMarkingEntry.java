...
public class StdVideoEncodeH264RefPicMarkingEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("memory_management_control_operation"),
        rgfw_h.C_SHORT.withName("difference_of_pic_nums_minus1"),
        rgfw_h.C_SHORT.withName("long_term_pic_num"),
        rgfw_h.C_SHORT.withName("long_term_frame_idx"),
        rgfw_h.C_SHORT.withName("max_long_term_frame_idx_plus1")
