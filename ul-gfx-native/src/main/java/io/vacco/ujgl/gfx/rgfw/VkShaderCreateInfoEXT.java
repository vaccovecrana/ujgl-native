...
public class VkShaderCreateInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("stage"),
        rgfw_h.C_INT.withName("nextStage"),
        rgfw_h.C_INT.withName("codeType"),
        rgfw_h.C_LONG.withName("codeSize"),
        rgfw_h.C_POINTER.withName("pCode"),
        rgfw_h.C_POINTER.withName("pName"),
        rgfw_h.C_INT.withName("setLayoutCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pSetLayouts"),
        rgfw_h.C_INT.withName("pushConstantRangeCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pPushConstantRanges"),
        rgfw_h.C_POINTER.withName("pSpecializationInfo")
