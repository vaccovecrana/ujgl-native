...
public class XClientMessageEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("message_type"),
    ...
    private static final long message_type$OFFSET = $LAYOUT.byteOffset(groupElement("message_type"));
    ...
    public static class data {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(20, rgfw_h.C_CHAR).withName("b"),
            MemoryLayout.sequenceLayout(10, rgfw_h.C_SHORT).withName("s"),
            MemoryLayout.sequenceLayout(5, rgfw_h.C_LONG).withName("l")
        ).withName("$anon$901:2");
        ...
        public static short s(MemorySegment union, long index0) {
            return (short)s$ELEM_HANDLE.get(union, s$OFFSET, index0);
        }
        ...
        public static long l(MemorySegment union, long index0) {
            return (long)l$ELEM_HANDLE.get(union, l$OFFSET, index0);
        }
        ...
        public static void l(MemorySegment union, long index0, long fieldValue) {
            l$ELEM_HANDLE.set(union, l$OFFSET, index0, fieldValue);
        }
