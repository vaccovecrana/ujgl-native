...
public class VkShaderStatisticsInfoAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("shaderStageMask"),
        MemoryLayout.paddingLayout(4),
        VkShaderResourceUsageAMD.layout().withName("resourceUsage"),
        rgfw_h.C_INT.withName("numPhysicalVgprs"),
        rgfw_h.C_INT.withName("numPhysicalSgprs"),
        rgfw_h.C_INT.withName("numAvailableVgprs"),
        rgfw_h.C_INT.withName("numAvailableSgprs"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("computeWorkGroupSize"),
        MemoryLayout.paddingLayout(4)
