...
public class VkVideoDecodeH265SessionParametersAddInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("stdVPSCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pStdVPSs"),
        glfw3_h.C_INT.withName("stdSPSCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pStdSPSs"),
        glfw3_h.C_INT.withName("stdPPSCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pStdPPSs")
