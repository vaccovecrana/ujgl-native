...
public class StdVideoDecodeH265PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("NumDeltaPocsOfRefRpsIdx"),
        rgfw_h.C_INT.withName("PicOrderCntVal"),
        rgfw_h.C_SHORT.withName("NumBitsForSTRefPicSetInSlice"),
        rgfw_h.C_SHORT.withName("reserved"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("RefPicSetStCurrBefore"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("RefPicSetStCurrAfter"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("RefPicSetLtCurr")
