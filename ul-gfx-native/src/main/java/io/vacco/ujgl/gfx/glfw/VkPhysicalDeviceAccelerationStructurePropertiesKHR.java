...
public class VkPhysicalDeviceAccelerationStructurePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_LONG.withName("maxPrimitiveCount"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorAccelerationStructures"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindAccelerationStructures"),
        glfw3_h.C_INT.withName("maxDescriptorSetAccelerationStructures"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindAccelerationStructures"),
        glfw3_h.C_INT.withName("minAccelerationStructureScratchOffsetAlignment"),
        MemoryLayout.paddingLayout(4)
