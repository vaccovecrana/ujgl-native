...
public class StdVideoH265VideoParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("vps_video_parameter_set_id"),
        glfw3_h.C_CHAR.withName("vps_max_sub_layers_minus1"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_CHAR.withName("reserved2"),
        glfw3_h.C_INT.withName("vps_num_units_in_tick"),
        glfw3_h.C_INT.withName("vps_time_scale"),
        glfw3_h.C_INT.withName("vps_num_ticks_poc_diff_one_minus1"),
