...
public class XExtCodes {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("extension"),
        rgfw_h.C_INT.withName("major_opcode"),
        rgfw_h.C_INT.withName("first_event"),
        rgfw_h.C_INT.withName("first_error")
    ).withName("$anon$156:9");
    ...
    private static final long extension$OFFSET = $LAYOUT.byteOffset(groupElement("extension"));
    ...
    private static final long major_opcode$OFFSET = $LAYOUT.byteOffset(groupElement("major_opcode"));
    ...
    private static final long first_event$OFFSET = $LAYOUT.byteOffset(groupElement("first_event"));
    ...
    private static final long first_error$OFFSET = $LAYOUT.byteOffset(groupElement("first_error"));
