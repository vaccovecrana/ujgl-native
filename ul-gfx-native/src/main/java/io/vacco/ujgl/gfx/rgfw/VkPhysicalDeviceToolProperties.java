...
public class VkPhysicalDeviceToolProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("name"),
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("version"),
        rgfw_h.C_INT.withName("purposes"),
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("description"),
        MemoryLayout.sequenceLayout(256, rgfw_h.C_CHAR).withName("layer"),
        MemoryLayout.paddingLayout(4)
