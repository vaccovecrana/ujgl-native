...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("_IO_read_ptr"),
        rgfw_h.C_POINTER.withName("_IO_read_end"),
        rgfw_h.C_POINTER.withName("_IO_read_base"),
        rgfw_h.C_POINTER.withName("_IO_write_base"),
        rgfw_h.C_POINTER.withName("_IO_write_ptr"),
        rgfw_h.C_POINTER.withName("_IO_write_end"),
        rgfw_h.C_POINTER.withName("_IO_buf_base"),
        rgfw_h.C_POINTER.withName("_IO_buf_end"),
        rgfw_h.C_POINTER.withName("_IO_save_base"),
        rgfw_h.C_POINTER.withName("_IO_backup_base"),
        rgfw_h.C_POINTER.withName("_IO_save_end"),
        rgfw_h.C_POINTER.withName("_markers"),
        rgfw_h.C_POINTER.withName("_chain"),
        rgfw_h.C_INT.withName("_fileno"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(1, rgfw_h.C_CHAR).withName("_short_backupbuf"),
        rgfw_h.C_LONG.withName("_old_offset"),
        rgfw_h.C_SHORT.withName("_cur_column"),
        rgfw_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, rgfw_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("_lock"),
        rgfw_h.C_LONG.withName("_offset"),
        rgfw_h.C_POINTER.withName("_codecvt"),
        rgfw_h.C_POINTER.withName("_wide_data"),
        rgfw_h.C_POINTER.withName("_freeres_list"),
        rgfw_h.C_POINTER.withName("_freeres_buf"),
        rgfw_h.C_POINTER.withName("_prevchain"),
        rgfw_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, rgfw_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
