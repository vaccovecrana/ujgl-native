...
public class XConfigureRequestEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("serial"),
        rgfw_h.C_INT.withName("send_event"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("display"),
        rgfw_h.C_LONG.withName("parent"),
        rgfw_h.C_LONG.withName("window"),
        ...
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("above"),
        rgfw_h.C_INT.withName("detail"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("value_mask")
    ).withName("$anon$797:9");
    ...
    private static final long serial$OFFSET = $LAYOUT.byteOffset(groupElement("serial"));
    ...
    private static final long above$OFFSET = $LAYOUT.byteOffset(groupElement("above"));
    ...
    private static final long value_mask$OFFSET = $LAYOUT.byteOffset(groupElement("value_mask"));
