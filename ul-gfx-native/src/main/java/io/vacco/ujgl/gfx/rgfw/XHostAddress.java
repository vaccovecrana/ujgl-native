...
public class XHostAddress {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("family"),
        rgfw_h.C_INT.withName("length"),
        rgfw_h.C_POINTER.withName("address")
    ).withName("$anon$337:9");
    ...
    private static final long family$OFFSET = $LAYOUT.byteOffset(groupElement("family"));
