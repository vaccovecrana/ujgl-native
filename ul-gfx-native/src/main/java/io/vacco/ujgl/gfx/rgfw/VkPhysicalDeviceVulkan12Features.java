...
public class VkPhysicalDeviceVulkan12Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("samplerMirrorClampToEdge"),
        rgfw_h.C_INT.withName("drawIndirectCount"),
        rgfw_h.C_INT.withName("storageBuffer8BitAccess"),
        rgfw_h.C_INT.withName("uniformAndStorageBuffer8BitAccess"),
        rgfw_h.C_INT.withName("storagePushConstant8"),
        rgfw_h.C_INT.withName("shaderBufferInt64Atomics"),
        rgfw_h.C_INT.withName("shaderSharedInt64Atomics"),
        rgfw_h.C_INT.withName("shaderFloat16"),
        rgfw_h.C_INT.withName("shaderInt8"),
        rgfw_h.C_INT.withName("descriptorIndexing"),
        rgfw_h.C_INT.withName("shaderInputAttachmentArrayDynamicIndexing"),
        rgfw_h.C_INT.withName("shaderUniformTexelBufferArrayDynamicIndexing"),
        rgfw_h.C_INT.withName("shaderStorageTexelBufferArrayDynamicIndexing"),
        rgfw_h.C_INT.withName("shaderUniformBufferArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderSampledImageArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderStorageBufferArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderStorageImageArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderUniformTexelBufferArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("shaderStorageTexelBufferArrayNonUniformIndexing"),
        rgfw_h.C_INT.withName("descriptorBindingUniformBufferUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingSampledImageUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingStorageImageUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingStorageBufferUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingUniformTexelBufferUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingStorageTexelBufferUpdateAfterBind"),
        rgfw_h.C_INT.withName("descriptorBindingUpdateUnusedWhilePending"),
        rgfw_h.C_INT.withName("descriptorBindingPartiallyBound"),
        rgfw_h.C_INT.withName("descriptorBindingVariableDescriptorCount"),
        rgfw_h.C_INT.withName("runtimeDescriptorArray"),
        rgfw_h.C_INT.withName("samplerFilterMinmax"),
        rgfw_h.C_INT.withName("scalarBlockLayout"),
        rgfw_h.C_INT.withName("imagelessFramebuffer"),
        rgfw_h.C_INT.withName("uniformBufferStandardLayout"),
        rgfw_h.C_INT.withName("shaderSubgroupExtendedTypes"),
        rgfw_h.C_INT.withName("separateDepthStencilLayouts"),
        rgfw_h.C_INT.withName("hostQueryReset"),
        rgfw_h.C_INT.withName("timelineSemaphore"),
        rgfw_h.C_INT.withName("bufferDeviceAddress"),
        rgfw_h.C_INT.withName("bufferDeviceAddressCaptureReplay"),
        rgfw_h.C_INT.withName("bufferDeviceAddressMultiDevice"),
        rgfw_h.C_INT.withName("vulkanMemoryModel"),
        rgfw_h.C_INT.withName("vulkanMemoryModelDeviceScope"),
        rgfw_h.C_INT.withName("vulkanMemoryModelAvailabilityVisibilityChains"),
        rgfw_h.C_INT.withName("shaderOutputViewportIndex"),
        rgfw_h.C_INT.withName("shaderOutputLayer"),
        rgfw_h.C_INT.withName("subgroupBroadcastDynamicId"),
        MemoryLayout.paddingLayout(4)
