...
public class VkBindSparseInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("waitSemaphoreCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pWaitSemaphores"),
        rgfw_h.C_INT.withName("bufferBindCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pBufferBinds"),
        rgfw_h.C_INT.withName("imageOpaqueBindCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pImageOpaqueBinds"),
        rgfw_h.C_INT.withName("imageBindCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pImageBinds"),
        rgfw_h.C_INT.withName("signalSemaphoreCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pSignalSemaphores")
