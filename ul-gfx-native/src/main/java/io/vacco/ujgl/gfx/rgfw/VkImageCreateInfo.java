...
public class VkImageCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("imageType"),
        rgfw_h.C_INT.withName("format"),
        VkExtent3D.layout().withName("extent"),
        rgfw_h.C_INT.withName("mipLevels"),
        rgfw_h.C_INT.withName("arrayLayers"),
        rgfw_h.C_INT.withName("samples"),
        rgfw_h.C_INT.withName("tiling"),
        rgfw_h.C_INT.withName("usage"),
        rgfw_h.C_INT.withName("sharingMode"),
        rgfw_h.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pQueueFamilyIndices"),
        rgfw_h.C_INT.withName("initialLayout"),
        MemoryLayout.paddingLayout(4)
