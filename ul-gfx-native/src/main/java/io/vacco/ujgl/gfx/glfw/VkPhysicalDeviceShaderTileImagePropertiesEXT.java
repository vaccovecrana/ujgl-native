...
public class VkPhysicalDeviceShaderTileImagePropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("shaderTileImageCoherentReadAccelerated"),
        glfw3_h.C_INT.withName("shaderTileImageReadSampleFromPixelRateInvocation"),
        glfw3_h.C_INT.withName("shaderTileImageReadFromHelperInvocation"),
        MemoryLayout.paddingLayout(4)
