...
public class StdVideoEncodeH264SliceHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("first_mb_in_slice"),
        glfw3_h.C_INT.withName("slice_type"),
        glfw3_h.C_CHAR.withName("slice_alpha_c0_offset_div2"),
        glfw3_h.C_CHAR.withName("slice_beta_offset_div2"),
        glfw3_h.C_CHAR.withName("slice_qp_delta"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_INT.withName("cabac_init_idc"),
        glfw3_h.C_INT.withName("disable_deblocking_filter_idc"),
