...
public class VkPhysicalDeviceDrmPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("hasPrimary"),
        glfw3_h.C_INT.withName("hasRender"),
        glfw3_h.C_LONG.withName("primaryMajor"),
        glfw3_h.C_LONG.withName("primaryMinor"),
        glfw3_h.C_LONG.withName("renderMajor"),
        glfw3_h.C_LONG.withName("renderMinor")
