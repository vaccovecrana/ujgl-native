...
public class VkVideoSessionCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("queueFamilyIndex"),
        rgfw_h.C_INT.withName("flags"),
        rgfw_h.C_POINTER.withName("pVideoProfile"),
        rgfw_h.C_INT.withName("pictureFormat"),
        VkExtent2D.layout().withName("maxCodedExtent"),
        rgfw_h.C_INT.withName("referencePictureFormat"),
        rgfw_h.C_INT.withName("maxDpbSlots"),
        rgfw_h.C_INT.withName("maxActiveReferencePictures"),
        rgfw_h.C_POINTER.withName("pStdHeaderVersion")
