...
public class _XExtData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("number"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("next"),
        rgfw_h.C_POINTER.withName("free_private"),
        rgfw_h.C_POINTER.withName("private_data")
    ).withName("_XExtData");
    ...
    private static final long number$OFFSET = $LAYOUT.byteOffset(groupElement("number"));
     ...
     * }
     */
    public final static class free_private {

        private free_private() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = rgfw_h.upcallHandle(free_private.Function.class, "apply", $DESC);
    ...
    private static final long free_private$OFFSET = $LAYOUT.byteOffset(groupElement("free_private"));
