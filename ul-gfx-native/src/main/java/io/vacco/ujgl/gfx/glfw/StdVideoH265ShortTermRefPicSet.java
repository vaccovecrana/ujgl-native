...
public class StdVideoH265ShortTermRefPicSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("delta_idx_minus1"),
        glfw3_h.C_SHORT.withName("use_delta_flag"),
        glfw3_h.C_SHORT.withName("abs_delta_rps_minus1"),
        glfw3_h.C_SHORT.withName("used_by_curr_pic_flag"),
        glfw3_h.C_SHORT.withName("used_by_curr_pic_s0_flag"),
        glfw3_h.C_SHORT.withName("used_by_curr_pic_s1_flag"),
        glfw3_h.C_SHORT.withName("reserved1"),
        glfw3_h.C_CHAR.withName("reserved2"),
        glfw3_h.C_CHAR.withName("reserved3"),
        glfw3_h.C_CHAR.withName("num_negative_pics"),
        glfw3_h.C_CHAR.withName("num_positive_pics"),
        MemoryLayout.sequenceLayout(16, glfw3_h.C_SHORT).withName("delta_poc_s0_minus1"),
        MemoryLayout.sequenceLayout(16, glfw3_h.C_SHORT).withName("delta_poc_s1_minus1")
