...
public class VkSamplerYcbcrConversionCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("ycbcrModel"),
        rgfw_h.C_INT.withName("ycbcrRange"),
        VkComponentMapping.layout().withName("components"),
        rgfw_h.C_INT.withName("xChromaOffset"),
        rgfw_h.C_INT.withName("yChromaOffset"),
        rgfw_h.C_INT.withName("chromaFilter"),
        rgfw_h.C_INT.withName("forceExplicitReconstruction"),
        MemoryLayout.paddingLayout(4)
