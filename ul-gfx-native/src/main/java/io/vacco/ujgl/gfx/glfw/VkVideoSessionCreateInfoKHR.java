...
public class VkVideoSessionCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("pVideoProfile"),
        glfw3_h.C_INT.withName("pictureFormat"),
        VkExtent2D.layout().withName("maxCodedExtent"),
        glfw3_h.C_INT.withName("referencePictureFormat"),
        glfw3_h.C_INT.withName("maxDpbSlots"),
        glfw3_h.C_INT.withName("maxActiveReferencePictures"),
        glfw3_h.C_POINTER.withName("pStdHeaderVersion")
