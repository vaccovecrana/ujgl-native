...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_POINTER.withName("fptr"),
        rgfw_h.C_POINTER.withName("rptr"),
        rgfw_h.C_POINTER.withName("state"),
        rgfw_h.C_INT.withName("rand_type"),
        rgfw_h.C_INT.withName("rand_deg"),
        rgfw_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("end_ptr")
