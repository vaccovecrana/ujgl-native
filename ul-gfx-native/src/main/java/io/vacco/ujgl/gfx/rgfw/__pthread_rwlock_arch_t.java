...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("__readers"),
        rgfw_h.C_INT.withName("__writers"),
        rgfw_h.C_INT.withName("__wrphase_futex"),
        rgfw_h.C_INT.withName("__writers_futex"),
        rgfw_h.C_INT.withName("__pad3"),
        rgfw_h.C_INT.withName("__pad4"),
        rgfw_h.C_INT.withName("__cur_writer"),
        rgfw_h.C_INT.withName("__shared"),
        rgfw_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("__pad1"),
        rgfw_h.C_LONG.withName("__pad2"),
        rgfw_h.C_INT.withName("__flags"),
