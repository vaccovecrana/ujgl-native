...
public class XWindowChanges {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("sibling"),
        rgfw_h.C_INT.withName("stack_mode"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$395:9");
    ...
    private static final long sibling$OFFSET = $LAYOUT.byteOffset(groupElement("sibling"));
    ...
    private static final long stack_mode$OFFSET = $LAYOUT.byteOffset(groupElement("stack_mode"));
