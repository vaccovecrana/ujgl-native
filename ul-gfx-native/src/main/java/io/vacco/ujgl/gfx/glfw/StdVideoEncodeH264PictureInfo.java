...
public class StdVideoEncodeH264PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_SHORT.withName("idr_pic_id"),
        glfw3_h.C_INT.withName("primary_pic_type"),
        glfw3_h.C_INT.withName("frame_num"),
        glfw3_h.C_INT.withName("PicOrderCnt"),
        glfw3_h.C_CHAR.withName("temporal_id"),
