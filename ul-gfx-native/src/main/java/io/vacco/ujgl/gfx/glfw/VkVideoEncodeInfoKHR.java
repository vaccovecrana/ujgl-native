...
public class VkVideoEncodeInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("dstBuffer"),
        glfw3_h.C_LONG.withName("dstBufferOffset"),
        glfw3_h.C_LONG.withName("dstBufferRange"),
        VkVideoPictureResourceInfoKHR.layout().withName("srcPictureResource"),
        glfw3_h.C_POINTER.withName("pSetupReferenceSlot"),
        glfw3_h.C_INT.withName("referenceSlotCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pReferenceSlots"),
        glfw3_h.C_INT.withName("precedingExternallyEncodedBytes"),
        MemoryLayout.paddingLayout(4)
