...
public class XCrossingEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("subwindow"),
        rgfw_h.C_LONG.withName("time"),
        rgfw_h.C_INT.withName("x"),
        rgfw_h.C_INT.withName("y"),
        rgfw_h.C_INT.withName("x_root"),
        rgfw_h.C_INT.withName("y_root"),
        rgfw_h.C_INT.withName("mode"),
        rgfw_h.C_INT.withName("detail"),
        rgfw_h.C_INT.withName("same_screen"),
        rgfw_h.C_INT.withName("focus"),
        rgfw_h.C_INT.withName("state"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$606:9");
    ...
    private static final long same_screen$OFFSET = $LAYOUT.byteOffset(groupElement("same_screen"));
