...
public class StdVideoAV1SequenceHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("seq_profile"),
        glfw3_h.C_CHAR.withName("frame_width_bits_minus_1"),
        glfw3_h.C_CHAR.withName("frame_height_bits_minus_1"),
        glfw3_h.C_SHORT.withName("max_frame_width_minus_1"),
        glfw3_h.C_SHORT.withName("max_frame_height_minus_1"),
        glfw3_h.C_CHAR.withName("delta_frame_id_length_minus_2"),
        glfw3_h.C_CHAR.withName("additional_frame_id_length_minus_1"),
        glfw3_h.C_CHAR.withName("order_hint_bits_minus_1"),
        glfw3_h.C_CHAR.withName("seq_force_integer_mv"),
        glfw3_h.C_CHAR.withName("seq_force_screen_content_tools"),
        MemoryLayout.sequenceLayout(5, glfw3_h.C_CHAR).withName("reserved1"),
        glfw3_h.C_POINTER.withName("pColorConfig"),
        glfw3_h.C_POINTER.withName("pTimingInfo")
