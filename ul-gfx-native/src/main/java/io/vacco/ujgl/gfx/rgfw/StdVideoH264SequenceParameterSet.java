...
public class StdVideoH264SequenceParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("profile_idc"),
        rgfw_h.C_INT.withName("level_idc"),
        rgfw_h.C_INT.withName("chroma_format_idc"),
        rgfw_h.C_CHAR.withName("seq_parameter_set_id"),
        rgfw_h.C_CHAR.withName("bit_depth_luma_minus8"),
        rgfw_h.C_CHAR.withName("bit_depth_chroma_minus8"),
        rgfw_h.C_CHAR.withName("log2_max_frame_num_minus4"),
        rgfw_h.C_INT.withName("pic_order_cnt_type"),
        rgfw_h.C_INT.withName("offset_for_non_ref_pic"),
        rgfw_h.C_INT.withName("offset_for_top_to_bottom_field"),
        rgfw_h.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
        rgfw_h.C_CHAR.withName("num_ref_frames_in_pic_order_cnt_cycle"),
        rgfw_h.C_CHAR.withName("max_num_ref_frames"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_INT.withName("pic_width_in_mbs_minus1"),
        rgfw_h.C_INT.withName("pic_height_in_map_units_minus1"),
        rgfw_h.C_INT.withName("frame_crop_left_offset"),
        rgfw_h.C_INT.withName("frame_crop_right_offset"),
        rgfw_h.C_INT.withName("frame_crop_top_offset"),
        rgfw_h.C_INT.withName("frame_crop_bottom_offset"),
        rgfw_h.C_INT.withName("reserved2"),
        rgfw_h.C_POINTER.withName("pOffsetForRefFrame"),
