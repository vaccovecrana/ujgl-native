...
public class StdVideoH265DecPicBufMgr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(7, rgfw_h.C_INT).withName("max_latency_increase_plus1"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("max_dec_pic_buffering_minus1"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("max_num_reorder_pics"),
