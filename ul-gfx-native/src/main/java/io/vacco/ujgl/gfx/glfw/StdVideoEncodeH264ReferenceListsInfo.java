...
public class StdVideoEncodeH264ReferenceListsInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("num_ref_idx_l0_active_minus1"),
        glfw3_h.C_CHAR.withName("num_ref_idx_l1_active_minus1"),
        MemoryLayout.sequenceLayout(32, glfw3_h.C_CHAR).withName("RefPicList0"),
        MemoryLayout.sequenceLayout(32, glfw3_h.C_CHAR).withName("RefPicList1"),
        glfw3_h.C_CHAR.withName("refList0ModOpCount"),
        glfw3_h.C_CHAR.withName("refList1ModOpCount"),
        glfw3_h.C_CHAR.withName("refPicMarkingOpCount"),
        MemoryLayout.sequenceLayout(7, glfw3_h.C_CHAR).withName("reserved1"),
        glfw3_h.C_POINTER.withName("pRefList0ModOperations"),
        glfw3_h.C_POINTER.withName("pRefList1ModOperations"),
        glfw3_h.C_POINTER.withName("pRefPicMarkingOperations")
