...
public class StdVideoAV1Segmentation {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("FeatureEnabled"),
        MemoryLayout.sequenceLayout(8, MemoryLayout.sequenceLayout(8, rgfw_h.C_SHORT)).withName("FeatureData")
