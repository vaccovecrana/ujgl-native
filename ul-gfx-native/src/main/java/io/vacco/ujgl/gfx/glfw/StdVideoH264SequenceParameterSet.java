...
public class StdVideoH264SequenceParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("profile_idc"),
        glfw3_h.C_INT.withName("level_idc"),
        glfw3_h.C_INT.withName("chroma_format_idc"),
        glfw3_h.C_CHAR.withName("seq_parameter_set_id"),
        glfw3_h.C_CHAR.withName("bit_depth_luma_minus8"),
        glfw3_h.C_CHAR.withName("bit_depth_chroma_minus8"),
        glfw3_h.C_CHAR.withName("log2_max_frame_num_minus4"),
        glfw3_h.C_INT.withName("pic_order_cnt_type"),
        glfw3_h.C_INT.withName("offset_for_non_ref_pic"),
        glfw3_h.C_INT.withName("offset_for_top_to_bottom_field"),
        glfw3_h.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
        glfw3_h.C_CHAR.withName("num_ref_frames_in_pic_order_cnt_cycle"),
        glfw3_h.C_CHAR.withName("max_num_ref_frames"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_INT.withName("pic_width_in_mbs_minus1"),
        glfw3_h.C_INT.withName("pic_height_in_map_units_minus1"),
        glfw3_h.C_INT.withName("frame_crop_left_offset"),
        glfw3_h.C_INT.withName("frame_crop_right_offset"),
        glfw3_h.C_INT.withName("frame_crop_top_offset"),
        glfw3_h.C_INT.withName("frame_crop_bottom_offset"),
        glfw3_h.C_INT.withName("reserved2"),
        glfw3_h.C_POINTER.withName("pOffsetForRefFrame"),
