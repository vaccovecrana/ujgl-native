...
public class StdVideoAV1CDEF {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_CHAR.withName("cdef_damping_minus_3"),
        rgfw_h.C_CHAR.withName("cdef_bits"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("cdef_y_pri_strength"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("cdef_y_sec_strength"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("cdef_uv_pri_strength"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("cdef_uv_sec_strength")
