...
public class StdVideoAV1ColorConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("BitDepth"),
        glfw3_h.C_CHAR.withName("subsampling_x"),
        glfw3_h.C_CHAR.withName("subsampling_y"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_INT.withName("color_primaries"),
        glfw3_h.C_INT.withName("transfer_characteristics"),
        glfw3_h.C_INT.withName("matrix_coefficients"),
        glfw3_h.C_INT.withName("chroma_sample_position")
