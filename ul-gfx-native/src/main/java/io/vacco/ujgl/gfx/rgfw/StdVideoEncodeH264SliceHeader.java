...
public class StdVideoEncodeH264SliceHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("first_mb_in_slice"),
        rgfw_h.C_INT.withName("slice_type"),
        rgfw_h.C_CHAR.withName("slice_alpha_c0_offset_div2"),
        rgfw_h.C_CHAR.withName("slice_beta_offset_div2"),
        rgfw_h.C_CHAR.withName("slice_qp_delta"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_INT.withName("cabac_init_idc"),
        rgfw_h.C_INT.withName("disable_deblocking_filter_idc"),
