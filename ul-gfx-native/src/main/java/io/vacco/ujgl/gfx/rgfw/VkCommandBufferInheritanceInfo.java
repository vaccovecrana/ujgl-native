...
public class VkCommandBufferInheritanceInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("framebuffer"),
        rgfw_h.C_INT.withName("occlusionQueryEnable"),
        rgfw_h.C_INT.withName("queryFlags"),
        rgfw_h.C_INT.withName("pipelineStatistics"),
        MemoryLayout.paddingLayout(4)
