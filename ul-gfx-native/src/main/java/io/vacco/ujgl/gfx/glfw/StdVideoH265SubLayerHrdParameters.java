...
public class StdVideoH265SubLayerHrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, glfw3_h.C_INT).withName("cpb_size_du_value_minus1"),
        MemoryLayout.sequenceLayout(32, glfw3_h.C_INT).withName("bit_rate_du_value_minus1"),
        glfw3_h.C_INT.withName("cbr_flag")
