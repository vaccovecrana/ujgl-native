...
public class StdVideoEncodeH264RefPicMarkingEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("memory_management_control_operation"),
        glfw3_h.C_SHORT.withName("difference_of_pic_nums_minus1"),
        glfw3_h.C_SHORT.withName("long_term_pic_num"),
        glfw3_h.C_SHORT.withName("long_term_frame_idx"),
        glfw3_h.C_SHORT.withName("max_long_term_frame_idx_plus1")
