...
public class StdVideoH264SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("matrix_coefficients"),
        glfw3_h.C_INT.withName("num_units_in_tick"),
        glfw3_h.C_INT.withName("time_scale"),
        glfw3_h.C_CHAR.withName("max_num_reorder_frames"),
        glfw3_h.C_CHAR.withName("max_dec_frame_buffering"),
        glfw3_h.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        glfw3_h.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        glfw3_h.C_INT.withName("reserved1"),
