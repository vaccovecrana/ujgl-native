...
public class VkVideoEncodeH265CapabilitiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("maxLevelIdc"),
        rgfw_h.C_INT.withName("maxSliceSegmentCount"),
        VkExtent2D.layout().withName("maxTiles"),
        rgfw_h.C_INT.withName("ctbSizes"),
        rgfw_h.C_INT.withName("transformBlockSizes"),
        rgfw_h.C_INT.withName("maxPPictureL0ReferenceCount"),
        rgfw_h.C_INT.withName("maxBPictureL0ReferenceCount"),
        rgfw_h.C_INT.withName("maxL1ReferenceCount"),
        rgfw_h.C_INT.withName("maxSubLayerCount"),
        rgfw_h.C_INT.withName("expectDyadicTemporalSubLayerPattern"),
        rgfw_h.C_INT.withName("minQp"),
        rgfw_h.C_INT.withName("maxQp"),
