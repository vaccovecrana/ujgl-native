...
public class VkAccelerationStructureTrianglesOpacityMicromapEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_LONG.withName("indexStride"),
        glfw3_h.C_INT.withName("baseTriangle"),
        glfw3_h.C_INT.withName("usageCountsCount"),
        glfw3_h.C_POINTER.withName("pUsageCounts"),
        glfw3_h.C_POINTER.withName("ppUsageCounts"),
        glfw3_h.C_POINTER.withName("micromap")
