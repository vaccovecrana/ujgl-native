...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, rgfw_h.C_POINTER).withName("__locales"),
        rgfw_h.C_POINTER.withName("__ctype_b"),
        rgfw_h.C_POINTER.withName("__ctype_tolower"),
        rgfw_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, rgfw_h.C_POINTER).withName("__names")
