...
public class StdVideoAV1TileInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("TileCols"),
        glfw3_h.C_CHAR.withName("TileRows"),
        glfw3_h.C_SHORT.withName("context_update_tile_id"),
        glfw3_h.C_CHAR.withName("tile_size_bytes_minus_1"),
        MemoryLayout.sequenceLayout(7, glfw3_h.C_CHAR).withName("reserved1"),
        glfw3_h.C_POINTER.withName("pMiColStarts"),
        glfw3_h.C_POINTER.withName("pMiRowStarts"),
        glfw3_h.C_POINTER.withName("pWidthInSbsMinus1"),
        glfw3_h.C_POINTER.withName("pHeightInSbsMinus1")
