...
public class VkPhysicalDeviceAccelerationStructurePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("maxGeometryCount"),
        rgfw_h.C_LONG.withName("maxInstanceCount"),
        rgfw_h.C_LONG.withName("maxPrimitiveCount"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorAccelerationStructures"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindAccelerationStructures"),
        rgfw_h.C_INT.withName("maxDescriptorSetAccelerationStructures"),
        rgfw_h.C_INT.withName("maxDescriptorSetUpdateAfterBindAccelerationStructures"),
        rgfw_h.C_INT.withName("minAccelerationStructureScratchOffsetAlignment"),
        MemoryLayout.paddingLayout(4)
