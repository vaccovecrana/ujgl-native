...
public class VkPhysicalDeviceSparseProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("residencyStandard2DBlockShape"),
        rgfw_h.C_INT.withName("residencyStandard2DMultisampleBlockShape"),
        rgfw_h.C_INT.withName("residencyStandard3DBlockShape"),
        rgfw_h.C_INT.withName("residencyAlignedMipSize"),
        rgfw_h.C_INT.withName("residencyNonResidentStrict")
