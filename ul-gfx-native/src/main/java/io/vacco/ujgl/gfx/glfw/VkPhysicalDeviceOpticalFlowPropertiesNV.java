...
public class VkPhysicalDeviceOpticalFlowPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("supportedOutputGridSizes"),
        glfw3_h.C_INT.withName("supportedHintGridSizes"),
        glfw3_h.C_INT.withName("hintSupported"),
        glfw3_h.C_INT.withName("costSupported"),
        glfw3_h.C_INT.withName("bidirectionalFlowSupported"),
        glfw3_h.C_INT.withName("globalFlowSupported"),
        glfw3_h.C_INT.withName("minWidth"),
        glfw3_h.C_INT.withName("minHeight"),
        glfw3_h.C_INT.withName("maxWidth"),
        glfw3_h.C_INT.withName("maxHeight"),
        glfw3_h.C_INT.withName("maxNumRegionsOfInterest"),
        MemoryLayout.paddingLayout(4)
