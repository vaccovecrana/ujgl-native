...
public class VkClearColorValue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, rgfw_h.C_FLOAT).withName("float32"),
        MemoryLayout.sequenceLayout(4, rgfw_h.C_INT).withName("int32"),
        MemoryLayout.sequenceLayout(4, rgfw_h.C_INT).withName("uint32")
