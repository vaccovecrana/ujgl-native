...
public class StdVideoEncodeH265SliceSegmentHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("slice_type"),
        glfw3_h.C_INT.withName("slice_segment_address"),
        glfw3_h.C_CHAR.withName("collocated_ref_idx"),
        glfw3_h.C_CHAR.withName("MaxNumMergeCand"),
        glfw3_h.C_CHAR.withName("slice_cb_qp_offset"),
        glfw3_h.C_CHAR.withName("slice_cr_qp_offset"),
        glfw3_h.C_CHAR.withName("slice_beta_offset_div2"),
        glfw3_h.C_CHAR.withName("slice_tc_offset_div2"),
        glfw3_h.C_CHAR.withName("slice_act_y_qp_offset"),
        glfw3_h.C_CHAR.withName("slice_act_cb_qp_offset"),
        glfw3_h.C_CHAR.withName("slice_act_cr_qp_offset"),
        glfw3_h.C_CHAR.withName("slice_qp_delta"),
        glfw3_h.C_SHORT.withName("reserved1"),
        glfw3_h.C_POINTER.withName("pWeightTable")
