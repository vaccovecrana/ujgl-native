...
public class VkGraphicsPipelineCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("stageCount"),
        rgfw_h.C_POINTER.withName("pStages"),
        rgfw_h.C_POINTER.withName("pVertexInputState"),
        rgfw_h.C_POINTER.withName("pInputAssemblyState"),
        rgfw_h.C_POINTER.withName("pTessellationState"),
        rgfw_h.C_POINTER.withName("pViewportState"),
        rgfw_h.C_POINTER.withName("pRasterizationState"),
        rgfw_h.C_POINTER.withName("pMultisampleState"),
        rgfw_h.C_POINTER.withName("pDepthStencilState"),
        rgfw_h.C_POINTER.withName("pColorBlendState"),
        rgfw_h.C_POINTER.withName("pDynamicState"),
        rgfw_h.C_POINTER.withName("layout"),
        rgfw_h.C_POINTER.withName("renderPass"),
        rgfw_h.C_INT.withName("subpass"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("basePipelineHandle"),
        rgfw_h.C_INT.withName("basePipelineIndex"),
        MemoryLayout.paddingLayout(4)
