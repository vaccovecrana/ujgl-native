...
public class VkPhysicalDeviceRayTracingPipelinePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxRayRecursionDepth"),
        glfw3_h.C_INT.withName("maxShaderGroupStride"),
        glfw3_h.C_INT.withName("shaderGroupBaseAlignment"),
        glfw3_h.C_INT.withName("shaderGroupHandleCaptureReplaySize"),
        glfw3_h.C_INT.withName("maxRayDispatchInvocationCount"),
        glfw3_h.C_INT.withName("shaderGroupHandleAlignment"),
        glfw3_h.C_INT.withName("maxRayHitAttributeSize")
