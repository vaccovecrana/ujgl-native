...
public class VkFrameBoundaryEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("frameID"),
        glfw3_h.C_INT.withName("imageCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pImages"),
        glfw3_h.C_INT.withName("bufferCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pBuffers"),
