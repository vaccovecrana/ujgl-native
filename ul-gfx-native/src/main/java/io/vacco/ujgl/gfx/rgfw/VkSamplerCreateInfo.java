...
public class VkSamplerCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("magFilter"),
        rgfw_h.C_INT.withName("minFilter"),
        rgfw_h.C_INT.withName("mipmapMode"),
        rgfw_h.C_INT.withName("addressModeU"),
        rgfw_h.C_INT.withName("addressModeV"),
        rgfw_h.C_INT.withName("addressModeW"),
        rgfw_h.C_FLOAT.withName("mipLodBias"),
        rgfw_h.C_INT.withName("anisotropyEnable"),
        rgfw_h.C_FLOAT.withName("maxAnisotropy"),
        rgfw_h.C_INT.withName("compareEnable"),
        rgfw_h.C_INT.withName("compareOp"),
        rgfw_h.C_FLOAT.withName("minLod"),
        rgfw_h.C_FLOAT.withName("maxLod"),
        rgfw_h.C_INT.withName("borderColor"),
        rgfw_h.C_INT.withName("unnormalizedCoordinates")
