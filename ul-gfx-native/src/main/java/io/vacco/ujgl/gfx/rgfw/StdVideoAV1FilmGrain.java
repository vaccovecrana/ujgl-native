...
public class StdVideoAV1FilmGrain {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("grain_scaling_minus_8"),
        rgfw_h.C_CHAR.withName("ar_coeff_lag"),
        rgfw_h.C_CHAR.withName("ar_coeff_shift_minus_6"),
        rgfw_h.C_CHAR.withName("grain_scale_shift"),
        rgfw_h.C_SHORT.withName("grain_seed"),
        rgfw_h.C_CHAR.withName("film_grain_params_ref_idx"),
        rgfw_h.C_CHAR.withName("num_y_points"),
        MemoryLayout.sequenceLayout(14, rgfw_h.C_CHAR).withName("point_y_value"),
        MemoryLayout.sequenceLayout(14, rgfw_h.C_CHAR).withName("point_y_scaling"),
        rgfw_h.C_CHAR.withName("num_cb_points"),
        MemoryLayout.sequenceLayout(10, rgfw_h.C_CHAR).withName("point_cb_value"),
        MemoryLayout.sequenceLayout(10, rgfw_h.C_CHAR).withName("point_cb_scaling"),
        rgfw_h.C_CHAR.withName("num_cr_points"),
        MemoryLayout.sequenceLayout(10, rgfw_h.C_CHAR).withName("point_cr_value"),
        MemoryLayout.sequenceLayout(10, rgfw_h.C_CHAR).withName("point_cr_scaling"),
        MemoryLayout.sequenceLayout(24, rgfw_h.C_CHAR).withName("ar_coeffs_y_plus_128"),
        MemoryLayout.sequenceLayout(25, rgfw_h.C_CHAR).withName("ar_coeffs_cb_plus_128"),
        MemoryLayout.sequenceLayout(25, rgfw_h.C_CHAR).withName("ar_coeffs_cr_plus_128"),
        rgfw_h.C_CHAR.withName("cb_mult"),
        rgfw_h.C_CHAR.withName("cb_luma_mult"),
        rgfw_h.C_SHORT.withName("cb_offset"),
        rgfw_h.C_CHAR.withName("cr_mult"),
        rgfw_h.C_CHAR.withName("cr_luma_mult"),
        rgfw_h.C_SHORT.withName("cr_offset")
