...
public class XIMValuesList {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_SHORT.withName("count_values"),
        MemoryLayout.paddingLayout(6),
        rgfw_h.C_POINTER.withName("supported_values")
    ).withName("$anon$1377:9");
    ...
    private static final long count_values$OFFSET = $LAYOUT.byteOffset(groupElement("count_values"));
    ...
    private static final long supported_values$OFFSET = $LAYOUT.byteOffset(groupElement("supported_values"));
