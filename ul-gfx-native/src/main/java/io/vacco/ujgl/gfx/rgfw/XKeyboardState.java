...
public class XKeyboardState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("key_click_percent"),
        rgfw_h.C_INT.withName("bell_percent"),
        rgfw_h.C_INT.withName("bell_pitch"),
        rgfw_h.C_INT.withName("bell_duration"),
        rgfw_h.C_LONG.withName("led_mask"),
        rgfw_h.C_INT.withName("global_auto_repeat"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("auto_repeats"),
    ...
    private static final long key_click_percent$OFFSET = $LAYOUT.byteOffset(groupElement("key_click_percent"));
    ...
    private static final long bell_percent$OFFSET = $LAYOUT.byteOffset(groupElement("bell_percent"));
    ...
    private static final long bell_pitch$OFFSET = $LAYOUT.byteOffset(groupElement("bell_pitch"));
    ...
    private static final long bell_duration$OFFSET = $LAYOUT.byteOffset(groupElement("bell_duration"));
    ...
    private static final long led_mask$OFFSET = $LAYOUT.byteOffset(groupElement("led_mask"));
    ...
    private static final long global_auto_repeat$OFFSET = $LAYOUT.byteOffset(groupElement("global_auto_repeat"));
    ...
    private static final long auto_repeats$OFFSET = $LAYOUT.byteOffset(groupElement("auto_repeats"));
    ...
    public static byte auto_repeats(MemorySegment struct, long index0) {
        return (byte)auto_repeats$ELEM_HANDLE.get(struct, auto_repeats$OFFSET, index0);
    }
    ...
    public static void auto_repeats(MemorySegment struct, long index0, byte fieldValue) {
        auto_repeats$ELEM_HANDLE.set(struct, auto_repeats$OFFSET, index0, fieldValue);
    }
