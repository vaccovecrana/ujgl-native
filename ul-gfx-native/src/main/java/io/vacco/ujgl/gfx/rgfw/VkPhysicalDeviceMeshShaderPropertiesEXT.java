...
public class VkPhysicalDeviceMeshShaderPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("maxTaskWorkGroupTotalCount"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxTaskWorkGroupCount"),
        rgfw_h.C_INT.withName("maxTaskWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxTaskWorkGroupSize"),
        rgfw_h.C_INT.withName("maxTaskPayloadSize"),
        rgfw_h.C_INT.withName("maxTaskSharedMemorySize"),
        rgfw_h.C_INT.withName("maxTaskPayloadAndSharedMemorySize"),
        rgfw_h.C_INT.withName("maxMeshWorkGroupTotalCount"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxMeshWorkGroupCount"),
        rgfw_h.C_INT.withName("maxMeshWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxMeshWorkGroupSize"),
        rgfw_h.C_INT.withName("maxMeshSharedMemorySize"),
        rgfw_h.C_INT.withName("maxMeshPayloadAndSharedMemorySize"),
        rgfw_h.C_INT.withName("maxMeshOutputMemorySize"),
        rgfw_h.C_INT.withName("maxMeshPayloadAndOutputMemorySize"),
        rgfw_h.C_INT.withName("maxMeshOutputComponents"),
        rgfw_h.C_INT.withName("maxMeshOutputVertices"),
        rgfw_h.C_INT.withName("maxMeshOutputPrimitives"),
        rgfw_h.C_INT.withName("maxMeshOutputLayers"),
        rgfw_h.C_INT.withName("maxMeshMultiviewViewCount"),
        rgfw_h.C_INT.withName("meshOutputPerVertexGranularity"),
        rgfw_h.C_INT.withName("meshOutputPerPrimitiveGranularity"),
        rgfw_h.C_INT.withName("maxPreferredTaskWorkGroupInvocations"),
        rgfw_h.C_INT.withName("maxPreferredMeshWorkGroupInvocations"),
        rgfw_h.C_INT.withName("prefersLocalInvocationVertexOutput"),
        rgfw_h.C_INT.withName("prefersLocalInvocationPrimitiveOutput"),
        rgfw_h.C_INT.withName("prefersCompactVertexOutput"),
        rgfw_h.C_INT.withName("prefersCompactPrimitiveOutput")
