...
public class VkShaderResourceUsageAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("numUsedVgprs"),
        rgfw_h.C_INT.withName("numUsedSgprs"),
        rgfw_h.C_INT.withName("ldsSizePerLocalWorkGroup"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("ldsUsageSizeInBytes"),
        rgfw_h.C_LONG.withName("scratchMemUsageInBytes")
