...
public class StdVideoAV1TileInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("TileCols"),
        rgfw_h.C_CHAR.withName("TileRows"),
        rgfw_h.C_SHORT.withName("context_update_tile_id"),
        rgfw_h.C_CHAR.withName("tile_size_bytes_minus_1"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("reserved1"),
        rgfw_h.C_POINTER.withName("pMiColStarts"),
        rgfw_h.C_POINTER.withName("pMiRowStarts"),
        rgfw_h.C_POINTER.withName("pWidthInSbsMinus1"),
        rgfw_h.C_POINTER.withName("pHeightInSbsMinus1")
