...
public class VkPhysicalDeviceDescriptorBufferPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("combinedImageSamplerDescriptorSingleArray"),
        glfw3_h.C_INT.withName("bufferlessPushDescriptors"),
        glfw3_h.C_INT.withName("allowSamplerImageViewPostSubmitCreation"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("descriptorBufferOffsetAlignment"),
        glfw3_h.C_INT.withName("maxDescriptorBufferBindings"),
        glfw3_h.C_INT.withName("maxResourceDescriptorBufferBindings"),
        glfw3_h.C_INT.withName("maxSamplerDescriptorBufferBindings"),
        glfw3_h.C_INT.withName("maxEmbeddedImmutableSamplerBindings"),
        glfw3_h.C_INT.withName("maxEmbeddedImmutableSamplers"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("bufferCaptureReplayDescriptorDataSize"),
        glfw3_h.C_LONG.withName("imageCaptureReplayDescriptorDataSize"),
        glfw3_h.C_LONG.withName("imageViewCaptureReplayDescriptorDataSize"),
        glfw3_h.C_LONG.withName("samplerCaptureReplayDescriptorDataSize"),
        glfw3_h.C_LONG.withName("accelerationStructureCaptureReplayDescriptorDataSize"),
        glfw3_h.C_LONG.withName("samplerDescriptorSize"),
        glfw3_h.C_LONG.withName("combinedImageSamplerDescriptorSize"),
        glfw3_h.C_LONG.withName("sampledImageDescriptorSize"),
        glfw3_h.C_LONG.withName("storageImageDescriptorSize"),
        glfw3_h.C_LONG.withName("uniformTexelBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("robustUniformTexelBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("storageTexelBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("robustStorageTexelBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("uniformBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("robustUniformBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("storageBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("robustStorageBufferDescriptorSize"),
        glfw3_h.C_LONG.withName("inputAttachmentDescriptorSize"),
        glfw3_h.C_LONG.withName("accelerationStructureDescriptorSize"),
        glfw3_h.C_LONG.withName("maxSamplerDescriptorBufferRange"),
        glfw3_h.C_LONG.withName("maxResourceDescriptorBufferRange"),
        glfw3_h.C_LONG.withName("samplerDescriptorBufferAddressSpaceSize"),
        glfw3_h.C_LONG.withName("resourceDescriptorBufferAddressSpaceSize"),
        glfw3_h.C_LONG.withName("descriptorBufferAddressSpaceSize")
