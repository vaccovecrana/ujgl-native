...
public class VkPerformanceValueDataINTEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        rgfw_h.C_INT.withName("value32"),
        rgfw_h.C_LONG.withName("value64"),
        rgfw_h.C_FLOAT.withName("valueFloat"),
        rgfw_h.C_INT.withName("valueBool"),
        rgfw_h.C_POINTER.withName("valueString")
