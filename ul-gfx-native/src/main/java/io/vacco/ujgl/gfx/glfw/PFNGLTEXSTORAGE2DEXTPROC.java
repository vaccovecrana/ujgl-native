 ...
 * }
 */
public final class PFNGLTEXSTORAGE2DEXTPROC {

    private PFNGLTEXSTORAGE2DEXTPROC() {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLTEXSTORAGE2DEXTPROC.Function.class, "apply", $DESC);
