...
public class VkGeneratedCommandsInfoNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("streamCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pStreams"),
        glfw3_h.C_INT.withName("sequencesCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("preprocessBuffer"),
        glfw3_h.C_LONG.withName("preprocessOffset"),
