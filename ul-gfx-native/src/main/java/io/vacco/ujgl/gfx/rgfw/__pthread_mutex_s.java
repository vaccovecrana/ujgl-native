...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("__lock"),
        rgfw_h.C_INT.withName("__count"),
        rgfw_h.C_INT.withName("__owner"),
        rgfw_h.C_INT.withName("__nusers"),
        rgfw_h.C_INT.withName("__kind"),
        rgfw_h.C_SHORT.withName("__spins"),
        rgfw_h.C_SHORT.withName("__elision"),
