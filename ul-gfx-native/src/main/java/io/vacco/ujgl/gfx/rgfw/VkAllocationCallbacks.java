...
public class VkAllocationCallbacks {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_POINTER.withName("pUserData"),
        rgfw_h.C_POINTER.withName("pfnAllocation"),
        rgfw_h.C_POINTER.withName("pfnReallocation"),
        rgfw_h.C_POINTER.withName("pfnFree"),
        rgfw_h.C_POINTER.withName("pfnInternalAllocation"),
        rgfw_h.C_POINTER.withName("pfnInternalFree")
