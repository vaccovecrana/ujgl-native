...
public class VkPerformanceCounterResultKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        rgfw_h.C_INT.withName("int32"),
        rgfw_h.C_LONG.withName("int64"),
        rgfw_h.C_INT.withName("uint32"),
        rgfw_h.C_LONG.withName("uint64"),
        rgfw_h.C_FLOAT.withName("float32"),
        rgfw_h.C_DOUBLE.withName("float64")
