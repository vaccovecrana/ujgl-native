...
public class VkVideoEncodeInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("dstBuffer"),
        rgfw_h.C_LONG.withName("dstBufferOffset"),
        rgfw_h.C_LONG.withName("dstBufferRange"),
        VkVideoPictureResourceInfoKHR.layout().withName("srcPictureResource"),
        rgfw_h.C_POINTER.withName("pSetupReferenceSlot"),
        rgfw_h.C_INT.withName("referenceSlotCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pReferenceSlots"),
        rgfw_h.C_INT.withName("precedingExternallyEncodedBytes"),
        MemoryLayout.paddingLayout(4)
