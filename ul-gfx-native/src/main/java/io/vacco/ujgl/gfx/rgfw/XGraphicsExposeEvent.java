...
public class XGraphicsExposeEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_LONG.withName("drawable"),
        rgfw_h.C_INT.withName("x"),
        rgfw_h.C_INT.withName("y"),
        rgfw_h.C_INT.withName("width"),
        rgfw_h.C_INT.withName("height"),
        rgfw_h.C_INT.withName("count"),
        rgfw_h.C_INT.withName("major_code"),
        rgfw_h.C_INT.withName("minor_code"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$669:9");
    ...
    private static final long drawable$OFFSET = $LAYOUT.byteOffset(groupElement("drawable"));
    ...
    private static final long major_code$OFFSET = $LAYOUT.byteOffset(groupElement("major_code"));
    ...
    private static final long minor_code$OFFSET = $LAYOUT.byteOffset(groupElement("minor_code"));
