...
public class XwcTextItem {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_POINTER.withName("chars"),
        rgfw_h.C_INT.withName("nchars"),
        rgfw_h.C_INT.withName("delta"),
        rgfw_h.C_POINTER.withName("font_set")
    ).withName("$anon$1099:9");
    ...
    private static final long chars$OFFSET = $LAYOUT.byteOffset(groupElement("chars"));
