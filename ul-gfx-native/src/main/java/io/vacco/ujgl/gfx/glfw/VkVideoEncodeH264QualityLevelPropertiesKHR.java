...
public class VkVideoEncodeH264QualityLevelPropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("preferredIdrPeriod"),
        glfw3_h.C_INT.withName("preferredConsecutiveBFrameCount"),
        glfw3_h.C_INT.withName("preferredTemporalLayerCount"),
        VkVideoEncodeH264QpKHR.layout().withName("preferredConstantQp"),
        glfw3_h.C_INT.withName("preferredMaxL0ReferenceCount"),
        glfw3_h.C_INT.withName("preferredMaxL1ReferenceCount"),
        glfw3_h.C_INT.withName("preferredStdEntropyCodingModeFlag"),
        MemoryLayout.paddingLayout(4)
