...
public class StdVideoAV1LoopFilter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, rgfw_h.C_CHAR).withName("loop_filter_level"),
        rgfw_h.C_CHAR.withName("loop_filter_sharpness"),
        rgfw_h.C_CHAR.withName("update_ref_delta"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("loop_filter_ref_deltas"),
        rgfw_h.C_CHAR.withName("update_mode_delta"),
        MemoryLayout.sequenceLayout(2, rgfw_h.C_CHAR).withName("loop_filter_mode_deltas"),
