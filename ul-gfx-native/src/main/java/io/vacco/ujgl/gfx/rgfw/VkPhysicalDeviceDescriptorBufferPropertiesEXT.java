...
public class VkPhysicalDeviceDescriptorBufferPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("combinedImageSamplerDescriptorSingleArray"),
        rgfw_h.C_INT.withName("bufferlessPushDescriptors"),
        rgfw_h.C_INT.withName("allowSamplerImageViewPostSubmitCreation"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("descriptorBufferOffsetAlignment"),
        rgfw_h.C_INT.withName("maxDescriptorBufferBindings"),
        rgfw_h.C_INT.withName("maxResourceDescriptorBufferBindings"),
        rgfw_h.C_INT.withName("maxSamplerDescriptorBufferBindings"),
        rgfw_h.C_INT.withName("maxEmbeddedImmutableSamplerBindings"),
        rgfw_h.C_INT.withName("maxEmbeddedImmutableSamplers"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("bufferCaptureReplayDescriptorDataSize"),
        rgfw_h.C_LONG.withName("imageCaptureReplayDescriptorDataSize"),
        rgfw_h.C_LONG.withName("imageViewCaptureReplayDescriptorDataSize"),
        rgfw_h.C_LONG.withName("samplerCaptureReplayDescriptorDataSize"),
        rgfw_h.C_LONG.withName("accelerationStructureCaptureReplayDescriptorDataSize"),
        rgfw_h.C_LONG.withName("samplerDescriptorSize"),
        rgfw_h.C_LONG.withName("combinedImageSamplerDescriptorSize"),
        rgfw_h.C_LONG.withName("sampledImageDescriptorSize"),
        rgfw_h.C_LONG.withName("storageImageDescriptorSize"),
        rgfw_h.C_LONG.withName("uniformTexelBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("robustUniformTexelBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("storageTexelBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("robustStorageTexelBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("uniformBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("robustUniformBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("storageBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("robustStorageBufferDescriptorSize"),
        rgfw_h.C_LONG.withName("inputAttachmentDescriptorSize"),
        rgfw_h.C_LONG.withName("accelerationStructureDescriptorSize"),
        rgfw_h.C_LONG.withName("maxSamplerDescriptorBufferRange"),
        rgfw_h.C_LONG.withName("maxResourceDescriptorBufferRange"),
        rgfw_h.C_LONG.withName("samplerDescriptorBufferAddressSpaceSize"),
        rgfw_h.C_LONG.withName("resourceDescriptorBufferAddressSpaceSize"),
        rgfw_h.C_LONG.withName("descriptorBufferAddressSpaceSize")
