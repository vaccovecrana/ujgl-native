...
public class VkVideoEncodeH264QualityLevelPropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("preferredIdrPeriod"),
        rgfw_h.C_INT.withName("preferredConsecutiveBFrameCount"),
        rgfw_h.C_INT.withName("preferredTemporalLayerCount"),
        VkVideoEncodeH264QpKHR.layout().withName("preferredConstantQp"),
        rgfw_h.C_INT.withName("preferredMaxL0ReferenceCount"),
        rgfw_h.C_INT.withName("preferredMaxL1ReferenceCount"),
        rgfw_h.C_INT.withName("preferredStdEntropyCodingModeFlag"),
        MemoryLayout.paddingLayout(4)
