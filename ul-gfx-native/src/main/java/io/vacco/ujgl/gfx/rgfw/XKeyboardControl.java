...
public class XKeyboardControl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("led"),
        rgfw_h.C_INT.withName("led_mode"),
        rgfw_h.C_INT.withName("key"),
        rgfw_h.C_INT.withName("auto_repeat_mode")
    ).withName("$anon$440:9");
    ...
    private static final long led$OFFSET = $LAYOUT.byteOffset(groupElement("led"));
    ...
    private static final long led_mode$OFFSET = $LAYOUT.byteOffset(groupElement("led_mode"));
    ...
    private static final long auto_repeat_mode$OFFSET = $LAYOUT.byteOffset(groupElement("auto_repeat_mode"));
