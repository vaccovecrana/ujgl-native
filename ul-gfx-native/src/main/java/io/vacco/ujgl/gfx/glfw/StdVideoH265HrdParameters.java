...
public class StdVideoH265HrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("tick_divisor_minus2"),
        glfw3_h.C_CHAR.withName("du_cpb_removal_delay_increment_length_minus1"),
        glfw3_h.C_CHAR.withName("dpb_output_delay_du_length_minus1"),
        glfw3_h.C_CHAR.withName("bit_rate_scale"),
        glfw3_h.C_CHAR.withName("cpb_size_scale"),
        glfw3_h.C_CHAR.withName("cpb_size_du_scale"),
        glfw3_h.C_CHAR.withName("initial_cpb_removal_delay_length_minus1"),
        glfw3_h.C_CHAR.withName("au_cpb_removal_delay_length_minus1"),
        glfw3_h.C_CHAR.withName("dpb_output_delay_length_minus1"),
        MemoryLayout.sequenceLayout(7, glfw3_h.C_CHAR).withName("cpb_cnt_minus1"),
        MemoryLayout.sequenceLayout(7, glfw3_h.C_SHORT).withName("elemental_duration_in_tc_minus1"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_SHORT).withName("reserved"),
        glfw3_h.C_POINTER.withName("pSubLayerHrdParametersNal"),
        glfw3_h.C_POINTER.withName("pSubLayerHrdParametersVcl")
