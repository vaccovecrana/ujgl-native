...
public class StdVideoDecodeH265PictureInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_CHAR.withName("NumDeltaPocsOfRefRpsIdx"),
        glfw3_h.C_INT.withName("PicOrderCntVal"),
        glfw3_h.C_SHORT.withName("NumBitsForSTRefPicSetInSlice"),
        glfw3_h.C_SHORT.withName("reserved"),
        MemoryLayout.sequenceLayout(8, glfw3_h.C_CHAR).withName("RefPicSetStCurrBefore"),
        MemoryLayout.sequenceLayout(8, glfw3_h.C_CHAR).withName("RefPicSetStCurrAfter"),
        MemoryLayout.sequenceLayout(8, glfw3_h.C_CHAR).withName("RefPicSetLtCurr")
