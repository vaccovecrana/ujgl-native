...
public class _XIMStringConversionText {
    ...
    public static class string {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            rgfw_h.C_POINTER.withName("mbs"),
            rgfw_h.C_POINTER.withName("wcs")
        ).withName("$anon$1291:5");
        ...
        private static final long mbs$OFFSET = $LAYOUT.byteOffset(groupElement("mbs"));
        ...
        private static final long wcs$OFFSET = $LAYOUT.byteOffset(groupElement("wcs"));
