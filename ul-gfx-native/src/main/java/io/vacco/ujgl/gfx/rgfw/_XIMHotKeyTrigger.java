...
public class _XIMHotKeyTrigger {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_LONG.withName("keysym"),
        rgfw_h.C_INT.withName("modifier"),
        rgfw_h.C_INT.withName("modifier_mask")
    ...
    private static final long keysym$OFFSET = $LAYOUT.byteOffset(groupElement("keysym"));
    ...
    private static final long modifier_mask$OFFSET = $LAYOUT.byteOffset(groupElement("modifier_mask"));
