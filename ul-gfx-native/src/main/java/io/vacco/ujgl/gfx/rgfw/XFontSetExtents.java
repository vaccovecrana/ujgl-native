...
public class XFontSetExtents {
    ...
    private static final long max_ink_extent$OFFSET = $LAYOUT.byteOffset(groupElement("max_ink_extent"));
    ...
    private static final long max_logical_extent$OFFSET = $LAYOUT.byteOffset(groupElement("max_logical_extent"));
