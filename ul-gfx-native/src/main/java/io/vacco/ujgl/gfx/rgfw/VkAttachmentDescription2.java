...
public class VkAttachmentDescription2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("loadOp"),
        rgfw_h.C_INT.withName("storeOp"),
        rgfw_h.C_INT.withName("stencilLoadOp"),
        rgfw_h.C_INT.withName("stencilStoreOp"),
        rgfw_h.C_INT.withName("initialLayout"),
        rgfw_h.C_INT.withName("finalLayout"),
        MemoryLayout.paddingLayout(4)
