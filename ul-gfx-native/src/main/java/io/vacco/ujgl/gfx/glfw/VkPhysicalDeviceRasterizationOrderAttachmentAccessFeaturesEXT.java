...
public class VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("rasterizationOrderColorAttachmentAccess"),
        glfw3_h.C_INT.withName("rasterizationOrderDepthAttachmentAccess"),
        glfw3_h.C_INT.withName("rasterizationOrderStencilAttachmentAccess"),
        MemoryLayout.paddingLayout(4)
