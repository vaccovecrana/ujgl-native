...
public class XOMOrientation {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("num_orientation"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("orientation")
    ).withName("$anon$1130:9");
    ...
    private static final long num_orientation$OFFSET = $LAYOUT.byteOffset(groupElement("num_orientation"));
