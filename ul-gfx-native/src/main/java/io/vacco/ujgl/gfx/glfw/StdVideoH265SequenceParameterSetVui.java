...
public class StdVideoH265SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("aspect_ratio_idc"),
        glfw3_h.C_SHORT.withName("sar_width"),
        glfw3_h.C_SHORT.withName("sar_height"),
        glfw3_h.C_CHAR.withName("video_format"),
        glfw3_h.C_CHAR.withName("colour_primaries"),
        glfw3_h.C_CHAR.withName("transfer_characteristics"),
        glfw3_h.C_CHAR.withName("matrix_coeffs"),
        glfw3_h.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        glfw3_h.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        glfw3_h.C_CHAR.withName("reserved1"),
        glfw3_h.C_CHAR.withName("reserved2"),
        glfw3_h.C_SHORT.withName("def_disp_win_left_offset"),
        glfw3_h.C_SHORT.withName("def_disp_win_right_offset"),
        glfw3_h.C_SHORT.withName("def_disp_win_top_offset"),
        glfw3_h.C_SHORT.withName("def_disp_win_bottom_offset"),
        glfw3_h.C_INT.withName("vui_num_units_in_tick"),
        glfw3_h.C_INT.withName("vui_time_scale"),
        glfw3_h.C_INT.withName("vui_num_ticks_poc_diff_one_minus1"),
        glfw3_h.C_SHORT.withName("min_spatial_segmentation_idc"),
        glfw3_h.C_SHORT.withName("reserved3"),
        glfw3_h.C_CHAR.withName("max_bytes_per_pic_denom"),
        glfw3_h.C_CHAR.withName("max_bits_per_min_cu_denom"),
        glfw3_h.C_CHAR.withName("log2_max_mv_length_horizontal"),
        glfw3_h.C_CHAR.withName("log2_max_mv_length_vertical"),
        glfw3_h.C_POINTER.withName("pHrdParameters")
