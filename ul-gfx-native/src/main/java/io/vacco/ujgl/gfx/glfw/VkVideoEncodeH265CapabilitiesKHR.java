...
public class VkVideoEncodeH265CapabilitiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxLevelIdc"),
        glfw3_h.C_INT.withName("maxSliceSegmentCount"),
        VkExtent2D.layout().withName("maxTiles"),
        glfw3_h.C_INT.withName("ctbSizes"),
        glfw3_h.C_INT.withName("transformBlockSizes"),
        glfw3_h.C_INT.withName("maxPPictureL0ReferenceCount"),
        glfw3_h.C_INT.withName("maxBPictureL0ReferenceCount"),
        glfw3_h.C_INT.withName("maxL1ReferenceCount"),
        glfw3_h.C_INT.withName("maxSubLayerCount"),
        glfw3_h.C_INT.withName("expectDyadicTemporalSubLayerPattern"),
        glfw3_h.C_INT.withName("minQp"),
        glfw3_h.C_INT.withName("maxQp"),
