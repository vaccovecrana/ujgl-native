...
public class StdVideoAV1GlobalMotion {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("GmType"),
        MemoryLayout.sequenceLayout(8, MemoryLayout.sequenceLayout(6, rgfw_h.C_INT)).withName("gm_params")
