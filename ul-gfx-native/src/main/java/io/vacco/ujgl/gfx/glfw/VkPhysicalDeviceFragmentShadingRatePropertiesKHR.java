...
public class VkPhysicalDeviceFragmentShadingRatePropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxFragmentShadingRateAttachmentTexelSizeAspectRatio"),
        glfw3_h.C_INT.withName("primitiveFragmentShadingRateWithMultipleViewports"),
        glfw3_h.C_INT.withName("layeredShadingRateAttachments"),
        glfw3_h.C_INT.withName("fragmentShadingRateNonTrivialCombinerOps"),
        VkExtent2D.layout().withName("maxFragmentSize"),
        glfw3_h.C_INT.withName("maxFragmentSizeAspectRatio"),
        glfw3_h.C_INT.withName("maxFragmentShadingRateCoverageSamples"),
        glfw3_h.C_INT.withName("maxFragmentShadingRateRasterizationSamples"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithShaderDepthStencilWrites"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithSampleMask"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithShaderSampleMask"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithConservativeRasterization"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithFragmentShaderInterlock"),
        glfw3_h.C_INT.withName("fragmentShadingRateWithCustomSampleLocations"),
        glfw3_h.C_INT.withName("fragmentShadingRateStrictMultiplyCombiner")
