...
public class StdVideoEncodeH265LongTermRefPics {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_CHAR.withName("num_long_term_sps"),
        rgfw_h.C_CHAR.withName("num_long_term_pics"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("lt_idx_sps"),
        MemoryLayout.sequenceLayout(16, rgfw_h.C_CHAR).withName("poc_lsb_lt"),
        rgfw_h.C_SHORT.withName("used_by_curr_pic_lt_flag"),
        MemoryLayout.sequenceLayout(48, rgfw_h.C_CHAR).withName("delta_poc_msb_present_flag"),
        MemoryLayout.sequenceLayout(48, rgfw_h.C_CHAR).withName("delta_poc_msb_cycle_lt")
