...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, rgfw_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_SHORT).withName("__old_x"),
        rgfw_h.C_SHORT.withName("__c"),
        rgfw_h.C_SHORT.withName("__init"),
        rgfw_h.C_LONG_LONG.withName("__a")
