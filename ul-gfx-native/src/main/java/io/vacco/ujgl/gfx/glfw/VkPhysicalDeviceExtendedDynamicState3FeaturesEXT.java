...
public class VkPhysicalDeviceExtendedDynamicState3FeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("extendedDynamicState3TessellationDomainOrigin"),
        glfw3_h.C_INT.withName("extendedDynamicState3DepthClampEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3PolygonMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3RasterizationSamples"),
        glfw3_h.C_INT.withName("extendedDynamicState3SampleMask"),
        glfw3_h.C_INT.withName("extendedDynamicState3AlphaToCoverageEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3AlphaToOneEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3LogicOpEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3ColorBlendEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3ColorBlendEquation"),
        glfw3_h.C_INT.withName("extendedDynamicState3ColorWriteMask"),
        glfw3_h.C_INT.withName("extendedDynamicState3RasterizationStream"),
        glfw3_h.C_INT.withName("extendedDynamicState3ConservativeRasterizationMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3ExtraPrimitiveOverestimationSize"),
        glfw3_h.C_INT.withName("extendedDynamicState3DepthClipEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3SampleLocationsEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3ColorBlendAdvanced"),
        glfw3_h.C_INT.withName("extendedDynamicState3ProvokingVertexMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3LineRasterizationMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3LineStippleEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3DepthClipNegativeOneToOne"),
        glfw3_h.C_INT.withName("extendedDynamicState3ViewportWScalingEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3ViewportSwizzle"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageToColorEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageToColorLocation"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageModulationMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageModulationTableEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageModulationTable"),
        glfw3_h.C_INT.withName("extendedDynamicState3CoverageReductionMode"),
        glfw3_h.C_INT.withName("extendedDynamicState3RepresentativeFragmentTestEnable"),
        glfw3_h.C_INT.withName("extendedDynamicState3ShadingRateImageEnable"),
        MemoryLayout.paddingLayout(4)
