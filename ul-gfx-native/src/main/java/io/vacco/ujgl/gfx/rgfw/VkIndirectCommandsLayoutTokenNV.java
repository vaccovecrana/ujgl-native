...
public class VkIndirectCommandsLayoutTokenNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("tokenType"),
        rgfw_h.C_INT.withName("stream"),
        rgfw_h.C_INT.withName("offset"),
        rgfw_h.C_INT.withName("vertexBindingUnit"),
        rgfw_h.C_INT.withName("vertexDynamicStride"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pushconstantPipelineLayout"),
        rgfw_h.C_INT.withName("pushconstantShaderStageFlags"),
        rgfw_h.C_INT.withName("pushconstantOffset"),
        rgfw_h.C_INT.withName("pushconstantSize"),
        rgfw_h.C_INT.withName("indirectStateFlags"),
        rgfw_h.C_INT.withName("indexTypeCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pIndexTypes"),
        rgfw_h.C_POINTER.withName("pIndexTypeValues")
