...
public class _XIMPreeditDrawCallbackStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("caret"),
        rgfw_h.C_INT.withName("chg_first"),
        rgfw_h.C_INT.withName("chg_length"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("text")
    ...
    private static final long caret$OFFSET = $LAYOUT.byteOffset(groupElement("caret"));
    ...
    private static final long chg_first$OFFSET = $LAYOUT.byteOffset(groupElement("chg_first"));
    ...
    private static final long chg_length$OFFSET = $LAYOUT.byteOffset(groupElement("chg_length"));
