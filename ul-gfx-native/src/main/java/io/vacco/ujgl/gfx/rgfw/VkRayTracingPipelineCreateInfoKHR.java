...
public class VkRayTracingPipelineCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("groupCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pGroups"),
        rgfw_h.C_INT.withName("maxPipelineRayRecursionDepth"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("pLibraryInfo"),
        rgfw_h.C_POINTER.withName("pLibraryInterface"),
