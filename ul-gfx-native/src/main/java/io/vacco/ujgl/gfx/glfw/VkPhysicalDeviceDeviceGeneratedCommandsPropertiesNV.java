...
public class VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxGraphicsShaderGroupCount"),
        glfw3_h.C_INT.withName("maxIndirectSequenceCount"),
        glfw3_h.C_INT.withName("maxIndirectCommandsTokenCount"),
        glfw3_h.C_INT.withName("maxIndirectCommandsStreamCount"),
        glfw3_h.C_INT.withName("maxIndirectCommandsTokenOffset"),
        glfw3_h.C_INT.withName("maxIndirectCommandsStreamStride"),
        glfw3_h.C_INT.withName("minSequencesCountBufferOffsetAlignment"),
        glfw3_h.C_INT.withName("minSequencesIndexBufferOffsetAlignment"),
        glfw3_h.C_INT.withName("minIndirectCommandsBufferOffsetAlignment"),
        MemoryLayout.paddingLayout(4)
