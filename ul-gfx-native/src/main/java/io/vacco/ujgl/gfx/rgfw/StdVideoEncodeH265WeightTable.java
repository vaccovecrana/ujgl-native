...
public class StdVideoEncodeH265WeightTable {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("luma_log2_weight_denom"),
        rgfw_h.C_CHAR.withName("delta_chroma_log2_weight_denom"),
        MemoryLayout.sequenceLayout(15, rgfw_h.C_CHAR).withName("delta_luma_weight_l0"),
        MemoryLayout.sequenceLayout(15, rgfw_h.C_CHAR).withName("luma_offset_l0"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, rgfw_h.C_CHAR)).withName("delta_chroma_weight_l0"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, rgfw_h.C_CHAR)).withName("delta_chroma_offset_l0"),
        MemoryLayout.sequenceLayout(15, rgfw_h.C_CHAR).withName("delta_luma_weight_l1"),
        MemoryLayout.sequenceLayout(15, rgfw_h.C_CHAR).withName("luma_offset_l1"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, rgfw_h.C_CHAR)).withName("delta_chroma_weight_l1"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, rgfw_h.C_CHAR)).withName("delta_chroma_offset_l1")
