...
public class VkVideoEncodeRateControlInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("rateControlMode"),
        glfw3_h.C_INT.withName("layerCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pLayers"),
        glfw3_h.C_INT.withName("virtualBufferSizeInMs"),
        glfw3_h.C_INT.withName("initialVirtualBufferSizeInMs")
