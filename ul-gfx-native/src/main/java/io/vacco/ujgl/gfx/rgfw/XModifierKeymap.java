...
public class XModifierKeymap {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("max_keypermod"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("modifiermap")
    ).withName("$anon$471:9");
    ...
    private static final long max_keypermod$OFFSET = $LAYOUT.byteOffset(groupElement("max_keypermod"));
    ...
    private static final long modifiermap$OFFSET = $LAYOUT.byteOffset(groupElement("modifiermap"));
