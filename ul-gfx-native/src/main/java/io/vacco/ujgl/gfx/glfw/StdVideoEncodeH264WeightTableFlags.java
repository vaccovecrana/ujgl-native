...
public class StdVideoEncodeH264WeightTableFlags {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("luma_weight_l0_flag"),
        glfw3_h.C_INT.withName("chroma_weight_l0_flag"),
        glfw3_h.C_INT.withName("luma_weight_l1_flag"),
        glfw3_h.C_INT.withName("chroma_weight_l1_flag")
