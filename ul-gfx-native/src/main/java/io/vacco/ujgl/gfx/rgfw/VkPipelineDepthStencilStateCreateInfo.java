...
public class VkPipelineDepthStencilStateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("depthTestEnable"),
        rgfw_h.C_INT.withName("depthWriteEnable"),
        rgfw_h.C_INT.withName("depthCompareOp"),
        rgfw_h.C_INT.withName("depthBoundsTestEnable"),
        rgfw_h.C_INT.withName("stencilTestEnable"),
        VkStencilOpState.layout().withName("front"),
        VkStencilOpState.layout().withName("back"),
        rgfw_h.C_FLOAT.withName("minDepthBounds"),
        rgfw_h.C_FLOAT.withName("maxDepthBounds")
