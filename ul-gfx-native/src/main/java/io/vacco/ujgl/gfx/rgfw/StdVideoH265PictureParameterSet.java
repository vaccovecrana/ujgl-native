...
public class StdVideoH265PictureParameterSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("pps_pic_parameter_set_id"),
        rgfw_h.C_CHAR.withName("pps_seq_parameter_set_id"),
        rgfw_h.C_CHAR.withName("sps_video_parameter_set_id"),
        rgfw_h.C_CHAR.withName("num_extra_slice_header_bits"),
        rgfw_h.C_CHAR.withName("num_ref_idx_l0_default_active_minus1"),
        rgfw_h.C_CHAR.withName("num_ref_idx_l1_default_active_minus1"),
        rgfw_h.C_CHAR.withName("init_qp_minus26"),
        rgfw_h.C_CHAR.withName("diff_cu_qp_delta_depth"),
        rgfw_h.C_CHAR.withName("pps_cb_qp_offset"),
        rgfw_h.C_CHAR.withName("pps_cr_qp_offset"),
        rgfw_h.C_CHAR.withName("pps_beta_offset_div2"),
        rgfw_h.C_CHAR.withName("pps_tc_offset_div2"),
        rgfw_h.C_CHAR.withName("log2_parallel_merge_level_minus2"),
        rgfw_h.C_CHAR.withName("log2_max_transform_skip_block_size_minus2"),
        rgfw_h.C_CHAR.withName("diff_cu_chroma_qp_offset_depth"),
        rgfw_h.C_CHAR.withName("chroma_qp_offset_list_len_minus1"),
        MemoryLayout.sequenceLayout(6, rgfw_h.C_CHAR).withName("cb_qp_offset_list"),
        MemoryLayout.sequenceLayout(6, rgfw_h.C_CHAR).withName("cr_qp_offset_list"),
        rgfw_h.C_CHAR.withName("log2_sao_offset_scale_luma"),
        rgfw_h.C_CHAR.withName("log2_sao_offset_scale_chroma"),
        rgfw_h.C_CHAR.withName("pps_act_y_qp_offset_plus5"),
        rgfw_h.C_CHAR.withName("pps_act_cb_qp_offset_plus5"),
        rgfw_h.C_CHAR.withName("pps_act_cr_qp_offset_plus3"),
        rgfw_h.C_CHAR.withName("pps_num_palette_predictor_initializers"),
        rgfw_h.C_CHAR.withName("luma_bit_depth_entry_minus8"),
        rgfw_h.C_CHAR.withName("chroma_bit_depth_entry_minus8"),
        rgfw_h.C_CHAR.withName("num_tile_columns_minus1"),
        rgfw_h.C_CHAR.withName("num_tile_rows_minus1"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_CHAR.withName("reserved2"),
        MemoryLayout.sequenceLayout(19, rgfw_h.C_SHORT).withName("column_width_minus1"),
        MemoryLayout.sequenceLayout(21, rgfw_h.C_SHORT).withName("row_height_minus1"),
        rgfw_h.C_INT.withName("reserved3"),
