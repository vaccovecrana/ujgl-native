...
public class VkPhysicalDeviceFragmentShadingRateFeaturesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("pipelineFragmentShadingRate"),
        glfw3_h.C_INT.withName("primitiveFragmentShadingRate"),
        glfw3_h.C_INT.withName("attachmentFragmentShadingRate"),
        MemoryLayout.paddingLayout(4)
