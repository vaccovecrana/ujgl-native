 ...
 * }
 */
public final class PFNGLDEPTHRANGEINDEXEDDNVPROC {

    private PFNGLDEPTHRANGEINDEXEDDNVPROC() {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLDEPTHRANGEINDEXEDDNVPROC.Function.class, "apply", $DESC);
