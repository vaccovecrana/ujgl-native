...
public class VkPhysicalDeviceLimits {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("maxImageDimension1D"),
        rgfw_h.C_INT.withName("maxImageDimension2D"),
        rgfw_h.C_INT.withName("maxImageDimension3D"),
        rgfw_h.C_INT.withName("maxImageDimensionCube"),
        rgfw_h.C_INT.withName("maxImageArrayLayers"),
        rgfw_h.C_INT.withName("maxTexelBufferElements"),
        rgfw_h.C_INT.withName("maxUniformBufferRange"),
        rgfw_h.C_INT.withName("maxStorageBufferRange"),
        rgfw_h.C_INT.withName("maxPushConstantsSize"),
        rgfw_h.C_INT.withName("maxMemoryAllocationCount"),
        rgfw_h.C_INT.withName("maxSamplerAllocationCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("bufferImageGranularity"),
        rgfw_h.C_LONG.withName("sparseAddressSpaceSize"),
        rgfw_h.C_INT.withName("maxBoundDescriptorSets"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorSamplers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorUniformBuffers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorStorageBuffers"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorSampledImages"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorStorageImages"),
        rgfw_h.C_INT.withName("maxPerStageDescriptorInputAttachments"),
        rgfw_h.C_INT.withName("maxPerStageResources"),
        rgfw_h.C_INT.withName("maxDescriptorSetSamplers"),
        rgfw_h.C_INT.withName("maxDescriptorSetUniformBuffers"),
        rgfw_h.C_INT.withName("maxDescriptorSetUniformBuffersDynamic"),
        rgfw_h.C_INT.withName("maxDescriptorSetStorageBuffers"),
        rgfw_h.C_INT.withName("maxDescriptorSetStorageBuffersDynamic"),
        rgfw_h.C_INT.withName("maxDescriptorSetSampledImages"),
        rgfw_h.C_INT.withName("maxDescriptorSetStorageImages"),
        rgfw_h.C_INT.withName("maxDescriptorSetInputAttachments"),
        rgfw_h.C_INT.withName("maxVertexInputAttributes"),
        rgfw_h.C_INT.withName("maxVertexInputBindings"),
        rgfw_h.C_INT.withName("maxVertexInputAttributeOffset"),
        rgfw_h.C_INT.withName("maxVertexInputBindingStride"),
        rgfw_h.C_INT.withName("maxVertexOutputComponents"),
        rgfw_h.C_INT.withName("maxTessellationGenerationLevel"),
        rgfw_h.C_INT.withName("maxTessellationPatchSize"),
        rgfw_h.C_INT.withName("maxTessellationControlPerVertexInputComponents"),
        rgfw_h.C_INT.withName("maxTessellationControlPerVertexOutputComponents"),
        rgfw_h.C_INT.withName("maxTessellationControlPerPatchOutputComponents"),
        rgfw_h.C_INT.withName("maxTessellationControlTotalOutputComponents"),
        rgfw_h.C_INT.withName("maxTessellationEvaluationInputComponents"),
        rgfw_h.C_INT.withName("maxTessellationEvaluationOutputComponents"),
        rgfw_h.C_INT.withName("maxGeometryShaderInvocations"),
        rgfw_h.C_INT.withName("maxGeometryInputComponents"),
        rgfw_h.C_INT.withName("maxGeometryOutputComponents"),
        rgfw_h.C_INT.withName("maxGeometryOutputVertices"),
        rgfw_h.C_INT.withName("maxGeometryTotalOutputComponents"),
        rgfw_h.C_INT.withName("maxFragmentInputComponents"),
        rgfw_h.C_INT.withName("maxFragmentOutputAttachments"),
        rgfw_h.C_INT.withName("maxFragmentDualSrcAttachments"),
        rgfw_h.C_INT.withName("maxFragmentCombinedOutputResources"),
        rgfw_h.C_INT.withName("maxComputeSharedMemorySize"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxComputeWorkGroupCount"),
        rgfw_h.C_INT.withName("maxComputeWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_INT).withName("maxComputeWorkGroupSize"),
        rgfw_h.C_INT.withName("subPixelPrecisionBits"),
        rgfw_h.C_INT.withName("subTexelPrecisionBits"),
        rgfw_h.C_INT.withName("mipmapPrecisionBits"),
        rgfw_h.C_INT.withName("maxDrawIndexedIndexValue"),
        rgfw_h.C_INT.withName("maxDrawIndirectCount"),
        rgfw_h.C_FLOAT.withName("maxSamplerLodBias"),
        rgfw_h.C_FLOAT.withName("maxSamplerAnisotropy"),
        rgfw_h.C_INT.withName("maxViewports"),
        MemoryLayout.sequenceLayout(2, rgfw_h.C_INT).withName("maxViewportDimensions"),
        MemoryLayout.sequenceLayout(2, rgfw_h.C_FLOAT).withName("viewportBoundsRange"),
        rgfw_h.C_INT.withName("viewportSubPixelBits"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("minMemoryMapAlignment"),
        rgfw_h.C_LONG.withName("minTexelBufferOffsetAlignment"),
        rgfw_h.C_LONG.withName("minUniformBufferOffsetAlignment"),
        rgfw_h.C_LONG.withName("minStorageBufferOffsetAlignment"),
        rgfw_h.C_INT.withName("minTexelOffset"),
        rgfw_h.C_INT.withName("maxTexelOffset"),
        rgfw_h.C_INT.withName("minTexelGatherOffset"),
        rgfw_h.C_INT.withName("maxTexelGatherOffset"),
        rgfw_h.C_FLOAT.withName("minInterpolationOffset"),
        rgfw_h.C_FLOAT.withName("maxInterpolationOffset"),
        rgfw_h.C_INT.withName("subPixelInterpolationOffsetBits"),
        rgfw_h.C_INT.withName("maxFramebufferWidth"),
        rgfw_h.C_INT.withName("maxFramebufferHeight"),
        rgfw_h.C_INT.withName("maxFramebufferLayers"),
        rgfw_h.C_INT.withName("framebufferColorSampleCounts"),
        rgfw_h.C_INT.withName("framebufferDepthSampleCounts"),
        rgfw_h.C_INT.withName("framebufferStencilSampleCounts"),
        rgfw_h.C_INT.withName("framebufferNoAttachmentsSampleCounts"),
        rgfw_h.C_INT.withName("maxColorAttachments"),
        rgfw_h.C_INT.withName("sampledImageColorSampleCounts"),
        rgfw_h.C_INT.withName("sampledImageIntegerSampleCounts"),
        rgfw_h.C_INT.withName("sampledImageDepthSampleCounts"),
        rgfw_h.C_INT.withName("sampledImageStencilSampleCounts"),
        rgfw_h.C_INT.withName("storageImageSampleCounts"),
        rgfw_h.C_INT.withName("maxSampleMaskWords"),
        rgfw_h.C_INT.withName("timestampComputeAndGraphics"),
        rgfw_h.C_FLOAT.withName("timestampPeriod"),
        rgfw_h.C_INT.withName("maxClipDistances"),
        rgfw_h.C_INT.withName("maxCullDistances"),
        rgfw_h.C_INT.withName("maxCombinedClipAndCullDistances"),
        rgfw_h.C_INT.withName("discreteQueuePriorities"),
        MemoryLayout.sequenceLayout(2, rgfw_h.C_FLOAT).withName("pointSizeRange"),
        MemoryLayout.sequenceLayout(2, rgfw_h.C_FLOAT).withName("lineWidthRange"),
        rgfw_h.C_FLOAT.withName("pointSizeGranularity"),
        rgfw_h.C_FLOAT.withName("lineWidthGranularity"),
        rgfw_h.C_INT.withName("strictLines"),
        rgfw_h.C_INT.withName("standardSampleLocations"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("optimalBufferCopyOffsetAlignment"),
        rgfw_h.C_LONG.withName("optimalBufferCopyRowPitchAlignment"),
        rgfw_h.C_LONG.withName("nonCoherentAtomSize")
