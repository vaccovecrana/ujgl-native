...
public class VkGeometryTrianglesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_POINTER.withName("vertexData"),
        rgfw_h.C_LONG.withName("vertexOffset"),
        rgfw_h.C_INT.withName("vertexCount"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("vertexStride"),
        rgfw_h.C_INT.withName("vertexFormat"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_POINTER.withName("indexData"),
        rgfw_h.C_LONG.withName("indexOffset"),
        rgfw_h.C_INT.withName("indexCount"),
        rgfw_h.C_INT.withName("indexType"),
        rgfw_h.C_POINTER.withName("transformData"),
        rgfw_h.C_LONG.withName("transformOffset")
