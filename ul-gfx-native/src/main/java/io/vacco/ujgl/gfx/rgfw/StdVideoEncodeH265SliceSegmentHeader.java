...
public class StdVideoEncodeH265SliceSegmentHeader {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("slice_type"),
        rgfw_h.C_INT.withName("slice_segment_address"),
        rgfw_h.C_CHAR.withName("collocated_ref_idx"),
        rgfw_h.C_CHAR.withName("MaxNumMergeCand"),
        rgfw_h.C_CHAR.withName("slice_cb_qp_offset"),
        rgfw_h.C_CHAR.withName("slice_cr_qp_offset"),
        rgfw_h.C_CHAR.withName("slice_beta_offset_div2"),
        rgfw_h.C_CHAR.withName("slice_tc_offset_div2"),
        rgfw_h.C_CHAR.withName("slice_act_y_qp_offset"),
        rgfw_h.C_CHAR.withName("slice_act_cb_qp_offset"),
        rgfw_h.C_CHAR.withName("slice_act_cr_qp_offset"),
        rgfw_h.C_CHAR.withName("slice_qp_delta"),
        rgfw_h.C_SHORT.withName("reserved1"),
        rgfw_h.C_POINTER.withName("pWeightTable")
