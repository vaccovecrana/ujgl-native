...
public class VkBlitImageInfo2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("srcImage"),
        glfw3_h.C_INT.withName("srcImageLayout"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("dstImage"),
        glfw3_h.C_INT.withName("dstImageLayout"),
        glfw3_h.C_INT.withName("regionCount"),
        glfw3_h.C_POINTER.withName("pRegions"),
        glfw3_h.C_INT.withName("filter"),
        MemoryLayout.paddingLayout(4)
