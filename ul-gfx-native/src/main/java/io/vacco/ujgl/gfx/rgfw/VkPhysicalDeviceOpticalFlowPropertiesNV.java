...
public class VkPhysicalDeviceOpticalFlowPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_INT.withName("supportedOutputGridSizes"),
        rgfw_h.C_INT.withName("supportedHintGridSizes"),
        rgfw_h.C_INT.withName("hintSupported"),
        rgfw_h.C_INT.withName("costSupported"),
        rgfw_h.C_INT.withName("bidirectionalFlowSupported"),
        rgfw_h.C_INT.withName("globalFlowSupported"),
        rgfw_h.C_INT.withName("minWidth"),
        rgfw_h.C_INT.withName("minHeight"),
        rgfw_h.C_INT.withName("maxWidth"),
        rgfw_h.C_INT.withName("maxHeight"),
        rgfw_h.C_INT.withName("maxNumRegionsOfInterest"),
        MemoryLayout.paddingLayout(4)
