...
public class XCharStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_SHORT.withName("lbearing"),
        rgfw_h.C_SHORT.withName("rbearing"),
        rgfw_h.C_SHORT.withName("width"),
        rgfw_h.C_SHORT.withName("ascent"),
        rgfw_h.C_SHORT.withName("descent"),
        rgfw_h.C_SHORT.withName("attributes")
    ...
    private static final long lbearing$OFFSET = $LAYOUT.byteOffset(groupElement("lbearing"));
    ...
    private static final long rbearing$OFFSET = $LAYOUT.byteOffset(groupElement("rbearing"));
