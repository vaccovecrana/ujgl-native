...
public class VkDeviceFaultVendorBinaryHeaderVersionOneEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("headerSize"),
        rgfw_h.C_INT.withName("headerVersion"),
        rgfw_h.C_INT.withName("vendorID"),
        rgfw_h.C_INT.withName("deviceID"),
        rgfw_h.C_INT.withName("driverVersion"),
        MemoryLayout.sequenceLayout(16, rgfw_h.C_CHAR).withName("pipelineCacheUUID"),
        rgfw_h.C_INT.withName("applicationNameOffset"),
        rgfw_h.C_INT.withName("applicationVersion"),
        rgfw_h.C_INT.withName("engineNameOffset"),
        rgfw_h.C_INT.withName("engineVersion"),
        rgfw_h.C_INT.withName("apiVersion")
