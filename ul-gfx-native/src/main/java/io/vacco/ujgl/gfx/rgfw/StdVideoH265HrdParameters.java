...
public class StdVideoH265HrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("tick_divisor_minus2"),
        rgfw_h.C_CHAR.withName("du_cpb_removal_delay_increment_length_minus1"),
        rgfw_h.C_CHAR.withName("dpb_output_delay_du_length_minus1"),
        rgfw_h.C_CHAR.withName("bit_rate_scale"),
        rgfw_h.C_CHAR.withName("cpb_size_scale"),
        rgfw_h.C_CHAR.withName("cpb_size_du_scale"),
        rgfw_h.C_CHAR.withName("initial_cpb_removal_delay_length_minus1"),
        rgfw_h.C_CHAR.withName("au_cpb_removal_delay_length_minus1"),
        rgfw_h.C_CHAR.withName("dpb_output_delay_length_minus1"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("cpb_cnt_minus1"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_SHORT).withName("elemental_duration_in_tc_minus1"),
        MemoryLayout.sequenceLayout(3, rgfw_h.C_SHORT).withName("reserved"),
        rgfw_h.C_POINTER.withName("pSubLayerHrdParametersNal"),
        rgfw_h.C_POINTER.withName("pSubLayerHrdParametersVcl")
