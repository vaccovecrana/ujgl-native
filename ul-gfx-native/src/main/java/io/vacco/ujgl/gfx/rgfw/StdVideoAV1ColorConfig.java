...
public class StdVideoAV1ColorConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("BitDepth"),
        rgfw_h.C_CHAR.withName("subsampling_x"),
        rgfw_h.C_CHAR.withName("subsampling_y"),
        rgfw_h.C_CHAR.withName("reserved1"),
        rgfw_h.C_INT.withName("color_primaries"),
        rgfw_h.C_INT.withName("transfer_characteristics"),
        rgfw_h.C_INT.withName("matrix_coefficients"),
        rgfw_h.C_INT.withName("chroma_sample_position")
