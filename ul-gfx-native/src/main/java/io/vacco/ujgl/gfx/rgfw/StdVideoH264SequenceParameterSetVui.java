...
public class StdVideoH264SequenceParameterSetVui {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("matrix_coefficients"),
        rgfw_h.C_INT.withName("num_units_in_tick"),
        rgfw_h.C_INT.withName("time_scale"),
        rgfw_h.C_CHAR.withName("max_num_reorder_frames"),
        rgfw_h.C_CHAR.withName("max_dec_frame_buffering"),
        rgfw_h.C_CHAR.withName("chroma_sample_loc_type_top_field"),
        rgfw_h.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
        rgfw_h.C_INT.withName("reserved1"),
