...
public class StdVideoEncodeH264ReferenceListsInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_CHAR.withName("num_ref_idx_l0_active_minus1"),
        rgfw_h.C_CHAR.withName("num_ref_idx_l1_active_minus1"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("RefPicList0"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("RefPicList1"),
        rgfw_h.C_CHAR.withName("refList0ModOpCount"),
        rgfw_h.C_CHAR.withName("refList1ModOpCount"),
        rgfw_h.C_CHAR.withName("refPicMarkingOpCount"),
        MemoryLayout.sequenceLayout(7, rgfw_h.C_CHAR).withName("reserved1"),
        rgfw_h.C_POINTER.withName("pRefList0ModOperations"),
        rgfw_h.C_POINTER.withName("pRefList1ModOperations"),
        rgfw_h.C_POINTER.withName("pRefPicMarkingOperations")
