...
public class VkPhysicalDeviceConservativeRasterizationPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        rgfw_h.C_FLOAT.withName("primitiveOverestimationSize"),
        rgfw_h.C_FLOAT.withName("maxExtraPrimitiveOverestimationSize"),
        rgfw_h.C_FLOAT.withName("extraPrimitiveOverestimationSizeGranularity"),
        rgfw_h.C_INT.withName("primitiveUnderestimation"),
        rgfw_h.C_INT.withName("conservativePointAndLineRasterization"),
        rgfw_h.C_INT.withName("degenerateTrianglesRasterized"),
        rgfw_h.C_INT.withName("degenerateLinesRasterized"),
        rgfw_h.C_INT.withName("fullyCoveredFragmentShaderInputVariable"),
        rgfw_h.C_INT.withName("conservativeRasterizationPostDepthCoverage"),
        MemoryLayout.paddingLayout(4)
