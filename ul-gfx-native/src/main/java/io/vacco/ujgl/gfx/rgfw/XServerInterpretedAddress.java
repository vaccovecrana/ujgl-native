...
public class XServerInterpretedAddress {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_INT.withName("typelength"),
        rgfw_h.C_INT.withName("valuelength"),
        rgfw_h.C_POINTER.withName("type"),
        rgfw_h.C_POINTER.withName("value")
    ).withName("$anon$346:9");
    ...
    private static final long typelength$OFFSET = $LAYOUT.byteOffset(groupElement("typelength"));
