...
public class VkPhysicalDeviceVulkan13Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("robustImageAccess"),
        glfw3_h.C_INT.withName("inlineUniformBlock"),
        glfw3_h.C_INT.withName("descriptorBindingInlineUniformBlockUpdateAfterBind"),
        glfw3_h.C_INT.withName("pipelineCreationCacheControl"),
        glfw3_h.C_INT.withName("privateData"),
        glfw3_h.C_INT.withName("shaderDemoteToHelperInvocation"),
        glfw3_h.C_INT.withName("shaderTerminateInvocation"),
        glfw3_h.C_INT.withName("subgroupSizeControl"),
        glfw3_h.C_INT.withName("computeFullSubgroups"),
        glfw3_h.C_INT.withName("synchronization2"),
        glfw3_h.C_INT.withName("textureCompressionASTC_HDR"),
        glfw3_h.C_INT.withName("shaderZeroInitializeWorkgroupMemory"),
        glfw3_h.C_INT.withName("dynamicRendering"),
        glfw3_h.C_INT.withName("shaderIntegerDotProduct"),
        glfw3_h.C_INT.withName("maintenance4"),
        MemoryLayout.paddingLayout(4)
