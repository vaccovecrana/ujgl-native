...
public class XKeymapEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("key_vector")
    ).withName("$anon$649:9");
    ...
    private static final long key_vector$OFFSET = $LAYOUT.byteOffset(groupElement("key_vector"));
    ...
    public static byte key_vector(MemorySegment struct, long index0) {
        return (byte)key_vector$ELEM_HANDLE.get(struct, key_vector$OFFSET, index0);
    }
    ...
    public static void key_vector(MemorySegment struct, long index0, byte fieldValue) {
        key_vector$ELEM_HANDLE.set(struct, key_vector$OFFSET, index0, fieldValue);
    }
