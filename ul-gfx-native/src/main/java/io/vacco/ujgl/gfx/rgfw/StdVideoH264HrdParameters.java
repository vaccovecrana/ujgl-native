...
public class StdVideoH264HrdParameters {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_CHAR.withName("cpb_cnt_minus1"),
        rgfw_h.C_CHAR.withName("bit_rate_scale"),
        rgfw_h.C_CHAR.withName("cpb_size_scale"),
        rgfw_h.C_CHAR.withName("reserved1"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_INT).withName("bit_rate_value_minus1"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_INT).withName("cpb_size_value_minus1"),
        MemoryLayout.sequenceLayout(32, rgfw_h.C_CHAR).withName("cbr_flag"),
        rgfw_h.C_INT.withName("initial_cpb_removal_delay_length_minus1"),
        rgfw_h.C_INT.withName("cpb_removal_delay_length_minus1"),
        rgfw_h.C_INT.withName("dpb_output_delay_length_minus1"),
        rgfw_h.C_INT.withName("time_offset_length")
