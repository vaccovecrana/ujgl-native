...
public class VkPhysicalDeviceVulkan11Properties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(16, rgfw_h.C_CHAR).withName("deviceUUID"),
        MemoryLayout.sequenceLayout(16, rgfw_h.C_CHAR).withName("driverUUID"),
        MemoryLayout.sequenceLayout(8, rgfw_h.C_CHAR).withName("deviceLUID"),
        rgfw_h.C_INT.withName("deviceNodeMask"),
        rgfw_h.C_INT.withName("deviceLUIDValid"),
        rgfw_h.C_INT.withName("subgroupSize"),
        rgfw_h.C_INT.withName("subgroupSupportedStages"),
        rgfw_h.C_INT.withName("subgroupSupportedOperations"),
        rgfw_h.C_INT.withName("subgroupQuadOperationsInAllStages"),
        rgfw_h.C_INT.withName("pointClippingBehavior"),
        rgfw_h.C_INT.withName("maxMultiviewViewCount"),
        rgfw_h.C_INT.withName("maxMultiviewInstanceIndex"),
        rgfw_h.C_INT.withName("protectedNoFault"),
        rgfw_h.C_INT.withName("maxPerSetDescriptors"),
        MemoryLayout.paddingLayout(4),
        rgfw_h.C_LONG.withName("maxMemoryAllocationSize")
