...
public class XColor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        rgfw_h.C_LONG.withName("pixel"),
        rgfw_h.C_SHORT.withName("red"),
        rgfw_h.C_SHORT.withName("green"),
        rgfw_h.C_SHORT.withName("blue"),
        rgfw_h.C_CHAR.withName("flags"),
        rgfw_h.C_CHAR.withName("pad")
    ).withName("$anon$406:9");
